#!/bin/bash
# This file was generated based on '/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/UnoCore/1.1.3/targets/ios/build.sh'.
...
##else
    xcodebuild -project "exploring.xcodeproj" "$@" | tee >(checkForError)
##endif
