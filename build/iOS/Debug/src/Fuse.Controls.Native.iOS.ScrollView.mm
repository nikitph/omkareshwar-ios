...
// public sealed extern class ScrollView :1661
// {
...
// public ScrollView(Fuse.Controls.Native.IScrollViewHost host) :1677
void ScrollView__ctor_4_fn(ScrollView* __this, uObject* host)
{
    __this->ctor_4(host);
}

// private static ObjC.Object AddCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) :1699
...
// private static void GetContentOffset(ObjC.Object handle, float& x, float& y) :1732
void ScrollView__GetContentOffset_fn(::g::ObjC::Object* handle, float* x, float* y)
{
    ScrollView::GetContentOffset(handle, x, y);
}

// public ScrollView New(Fuse.Controls.Native.IScrollViewHost host) :1677
void ScrollView__New3_fn(uObject* host, ScrollView** __retval)
{
    *__retval = ScrollView::New3(host);
}

// private void OnScrollViewDidScroll(ObjC.Object scrollViewHandle) :1708
...
// public void set_AllowedScrollDirections(Fuse.Controls.ScrollDirections value) [instance] :1668
void ScrollView::AllowedScrollDirections(int value)
{
}

// private void OnScrollViewDidScroll(ObjC.Object scrollViewHandle) [instance] :1708
...
// public void set_ScrollPosition(float2 value) [instance] :1673
void ScrollView::ScrollPosition(::g::Uno::Float2 value)
{
    ScrollView::SetContentOffset(Handle(), value.X, value.Y);
}

// private static ObjC.Object AddCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) [static] :1699
...
// private static ObjC.Object Create() [static] :1690
...
// private static void GetContentOffset(ObjC.Object handle, float& x, float& y) [static] :1732
...
// public ScrollView New(Fuse.Controls.Native.IScrollViewHost host) [static] :1677
...
// private static void SetContentOffset(ObjC.Object handle, float x, float y) [static] :1722
...
// private static void SetContentSize(ObjC.Object handle, float w, float h) [static] :1741
