...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.1.1/$.uno");
...
void Busy::UpdateState()
{
    ...
    if ((_rootOn & 1) == 1)
    {
        ...
        {
            _rootOn = (_rootOn & -2);
            ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"On='Paramet...*/], this, ::STRINGS[3/*"/Users/Omka...*/], 203, ::STRINGS[7/*"UpdateState"*/], NULL);
        }
        else
...
void Busy::activate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[2/*"Busy.activa...*/], b, ::STRINGS[3/*"/Users/Omka...*/], 264, ::STRINGS[0/*"activate"*/], NULL);
        return;
    }
...
void Busy::deactivate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"Busy.deacti...*/], b, ::STRINGS[3/*"/Users/Omka...*/], 282, ::STRINGS[1/*"deactivate"*/], NULL);
        return;
    }
...
void Completed::reset(::g::Fuse::Scripting::Context* c, Completed* cp, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Completed.r...*/], cp, ::STRINGS[3/*"/Users/Omka...*/], 824, ::STRINGS[10/*"reset"*/], NULL);
        return;
    }
...
uObject* BusyTaskModule__ConstructorClosure::Construct(uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[12/*"Use the `Bu...*/], this, ::STRINGS[3/*"/Users/Omka...*/], 580, ::STRINGS[13/*"Construct"*/]);
...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.1.1/triggers/$.uno
// ---------------------------------------------------------------------------------------------------------------
...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.1.1/actions/$.uno
// ---------------------------------------------------------------------------------------------------
...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.1.1/triggers/$.uno
// ----------------------------------------------------------------------------------------------------
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[16/*"Double remo...*/], __this, ::STRINGS[3/*"/Users/Omka...*/], 1742, ::STRINGS[17/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[18/*"Unexpected ...*/], this, ::STRINGS[3/*"/Users/Omka...*/], 1755, ::STRINGS[19/*"OnDone"*/]);
        return;
    }
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/1.1.1/triggers/$.uno");
...
void Scrolled__OnRooted_fn(Scrolled* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"Scrolled co...*/], __this, ::STRINGS[22/*"/Users/Omka...*/], 288, ::STRINGS[24/*"OnRooted"*/], NULL);
        return;
    }
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[21/*"check takes...*/], s, ::STRINGS[22/*"/Users/Omka...*/], 242, ::STRINGS[20/*"check"*/], NULL);
        return;
    }
...
void State::Goto()
{
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Cannot call...*/], NULL, ::STRINGS[3/*"/Users/Omka...*/], 2110, ::STRINGS[27/*"Goto"*/]);
        return;
    }
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[29/*"StateGroup....*/], n, ::STRINGS[3/*"/Users/Omka...*/], 1825, ::STRINGS[30/*"goto_"*/], NULL);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[31/*"Unable to f...*/], name), n, ::STRINGS[3/*"/Users/Omka...*/], 1805, ::STRINGS[32/*"gotoName"*/], NULL);
        return;
    }
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/Omka...*/], 2536, ::STRINGS[39/*"playTo"*/], NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/Omka...*/], 2585, ::STRINGS[41/*"seek"*/], NULL);
        return;
    }
...
static void TransitionGroup_build(uType* type)
{
    ...
    ::STRINGS[45] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/1.1.1/$.uno");
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[44/*"Transition ...*/], t, ::STRINGS[45/*"/Users/Omka...*/], 2782, ::STRINGS[46/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[47/*"Transition ...*/], t, ::STRINGS[45/*"/Users/Omka...*/], 2789, ::STRINGS[46/*"Root"*/], NULL);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[48/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"/Users/Omka...*/], 2879, ::STRINGS[49/*"Fuse.Animat...*/]);
        return;
    }
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[51/*"`Pulse` on ...*/], this, ::STRINGS[3/*"/Users/Omka...*/], 4249, ::STRINGS[52/*"Pulse"*/]);
