...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Experimental.Http/1.1.1/$.uno
// -----------------------------------------------------------------------------------------------
...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Experimental.Http/1.1.1/$.uno");
...
bool Loader::LoadCache(uObject* record)
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log2(e, 1, ::STRINGS[9/*"/Users/Omka...*/], 853);
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[10/*"Failed load...*/], Uri), 1, ::STRINGS[9/*"/Users/Omka...*/], 854);
