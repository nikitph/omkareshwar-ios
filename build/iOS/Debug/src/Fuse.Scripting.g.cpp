...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.1.1/$.uno
// --------------------------------------------------------------------------------------------
...
::g::Fuse::Scripting::Array* Context::NewArray(uArray* values)
{
    ...
    ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(uPtr(_newArray)->Call(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 1, uBox<int>(::TYPES[45/*int*/], uPtr(values)->Length()))), ::TYPES[10/*Fuse.Scripting.Array*/]);
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.1.1/$.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[22/*"this.Contex...*/], ::STRINGS[23/*"/Users/Omka...*/], 899, uArray::New(::TYPES[8/*object[]*/], 0));
...
static void NativeEventEmitterModule_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[8] = uObject_typeof()->Array();
    ::TYPES[34] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::TYPES[12/*Fuse.Scripting.Callback*/], NULL), NULL);
    type->SetInterfaces(
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[27/*"require(): ...*/], uBox<int>(::TYPES[45/*int*/], uPtr(args)->Length())), ::STRINGS[28/*" provided"*/])));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[31/*"JavaScript ...*/], path), ::STRINGS[32/*" was fixed!"*/]), this, ::STRINGS[23/*"/Users/Omka...*/], 1879, ::STRINGS[33/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[31/*"JavaScript ...*/], path), ::STRINGS[34/*" line "*/]), uBox<int>(::TYPES[45/*int*/], uPtr(e)->LineNumber())), ::STRINGS[35/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[23/*"/Users/Omka...*/], 1889, ::STRINGS[33/*"Require"*/], NULL);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[42/*"Cannot call...*/], __this, ::STRINGS[23/*"/Users/Omka...*/], 1582, ::STRINGS[43/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[49/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[50/*") { "*/]), uString::CharArray(newlines)), __this->GetEffectiveCode()), ::STRINGS[51/*"\n })"*/]);
...
uString* ScriptModule::ComputePath(uString* moduleId, bool* isFile)
{
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[45/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[45/*".js"*/], ::STRINGS[8/*""*/]);
