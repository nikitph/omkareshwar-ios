...
#include <_root.exploring_FuseDrawingSolidColor_Color_Property.h>
...
// public Template2(ExploreItem parent, ExploreItem parentInstance) :172
...
void ExploreItem__Template2__New1_fn(ExploreItem__Template2* __this, uObject** __retval)
{
    ...
    __this->TheColor_Color_inst = ::g::exploring_FuseDrawingSolidColor_Color_Property::New1(TheColor1, ExploreItem__Template2::__selector0());
    ...
    __self1->Width(::g::Uno::UX::Size__New1(6.0f, 1));
    __self1->Height(::g::Uno::UX::Size__New1(6.0f, 1));
    __self1->Margin(::g::Uno::Float4__New2(5.0f, 5.0f, 5.0f, 5.0f));
    __self1->Name(ExploreItem__Template2::__selector1());
    ...
    temp3->Factor(1.2f);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__self1->Fills()), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Drawing.Brush>*/]), TheColor1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(__self1->Strokes()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Drawing.Stroke>*/]), temp);
...
// public Template2 New(ExploreItem parent, ExploreItem parentInstance) :172
...
// public Template2(ExploreItem parent, ExploreItem parentInstance) [instance] :172
...
// public Template2 New(ExploreItem parent, ExploreItem parentInstance) [static] :172
