...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Expressions/1.1.1/$.uno
// -------------------------------------------------------------------------------------------------------

// public sealed class Add :896
// {
...
// protected override sealed object Compute(object left, object right) :900
...
// public override sealed string get_Symbol() :905
...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.1.1/$.uno
// ------------------------------------------------------------------------------------------------------
...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.1.1/$.uno
// ----------------------------------------------------------------------------------------------------
...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.1.1/$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    if (::g::Uno::String::op_Inequality(::g::Uno::UX::Selector__op_Implicit1(::g::Fuse::Reactive::IEventRecord::Sender(uInterface(uPtr(_e), ::TYPES[6/*Fuse.Reactive.IEventRecord*/]))), NULL))
        uPtr(obj)->Item(::STRINGS[4/*"sender"*/], uBox(::TYPES[33/*Uno.UX.Selector*/], ::g::Fuse::Reactive::IEventRecord::Sender(uInterface(uPtr(_e), ::TYPES[6/*Fuse.Reactive.IEventRecord*/]))));
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[5/*"JavaScript ...*/], ex, this, ::STRINGS[6/*"/Users/Omka...*/], 207, ::STRINGS[7/*"Call"*/]);
        }
        else throw __t;
    }
}
...
// protected override sealed object Compute(object a, object mn, object mx) :793
void Clamp__Compute_fn(Clamp* __this, uObject* a, uObject* mn, uObject* mx, uObject** __retval)
{
    ...
    if (size == 2)
        return *__retval = uBox(::TYPES[84/*float2*/], ::g::Uno::Math::Clamp2(::g::Uno::Float2__New2(av.X, av.Y), mnv, mxv)), void();

    if (size == 3)
        return *__retval = uBox(::TYPES[85/*float3*/], ::g::Uno::Math::Clamp4(::g::Uno::Float3__New2(av.X, av.Y, av.Z), mnv, mxv)), void();

    if (size == 4)
        return *__retval = uBox(::TYPES[86/*float4*/], ::g::Uno::Math::Clamp6(av, mnv, mxv)), void();

    return *__retval = NULL, void();
}

// public override sealed string ToString() :814
...
static void ClassInstance_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[15/*Uno.Collections.Dictionary<Uno.UX.Property, Fuse.Reactive.ObservableProperty>*/], offsetof(::g::Fuse::Reactive::ClassInstance, _properties), 0,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::Fuse::Reactive::ClassInstance, _rootTable), 0,
        ::TYPES[16/*Fuse.Scripting.Object*/], offsetof(::g::Fuse::Reactive::ClassInstance, _self), 0,
...
// public sealed class Conditional :960
// {
...
// protected override sealed object Compute(object cond, object trueVal, object falseVal) :966
...
// protected override sealed bool get_IsThirdOptional() :973
...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.1.1/fusejs/$.uno
// -------------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[15] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.1.1/fusejs/$.uno");
    ::STRINGS[16] = uString::Const("null");
    ::STRINGS[17] = uString::Const("\"");
    ::STRINGS[18] = uString::Const("function");
    ::STRINGS[19] = uString::Const("Object");
    ::STRINGS[20] = uString::Const("");
    ::STRINGS[21] = uString::Const(": ");
    ::STRINGS[22] = uString::Const("Array[");
    ::STRINGS[23] = uString::Const("]");
    ::STRINGS[24] = uString::Const("  ");
    ::STRINGS[25] = uString::Const("log");
    ::STRINGS[26] = uString::Const("dir");
    ::STRINGS[27] = uString::Const("console");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[15/*"/Users/Omka...*/], 135);
    return NULL;
}
...
void Console::Dir1(::g::Uno::Text::StringBuilder* builder, uObject* obj, int maxDepth, int indent)
{
    ...
    if (obj == NULL)
    {
        uPtr(builder)->AppendLine(::STRINGS[16/*"null"*/]);
        return;
    }
    ...
    {
        uPtr(builder)->AppendLine(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[17/*"\""*/], ::g::Uno::Object::ToString(uPtr(obj))), ::STRINGS[17/*"\""*/]));
        return;
    }

    if (uIs(obj, ::TYPES[25/*Fuse.Scripting.Function*/]))
    {
        uPtr(builder)->AppendLine(::STRINGS[18/*"function"*/]);
        return;
    }
    ...
    if (uIs(obj, ::TYPES[16/*Fuse.Scripting.Object*/]))
    {
        ...
        uPtr(builder)->AppendLine(::STRINGS[19/*"Object"*/]);
        ...
        if (indent <= maxDepth)
            ...
            for (array1 = uPtr(o)->Keys(), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
            {
                ...
                Console::Indent(builder, indent);
                uPtr(builder)->Append2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[20/*""*/], k), ::STRINGS[21/*": "*/]));
    ...
    if (uIs(obj, ::TYPES[26/*Fuse.Scripting.Array*/]))
    {
        ...
        uPtr(builder)->AppendLine(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[22/*"Array["*/], uBox<int>(::TYPES[20/*int*/], uPtr(a)->Length())), ::STRINGS[23/*"]"*/]));
        ...
        if (indent <= maxDepth)
            ...
            {
                Console::Indent(builder, indent);
                uPtr(builder)->Append2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[20/*""*/], uBox<int>(::TYPES[20/*int*/], i)), ::STRINGS[21/*": "*/]));
...
void Console::Indent(::g::Uno::Text::StringBuilder* builder, int indent)
{
    for (int i = 0; i < indent; i++)
        uPtr(builder)->Append2(::STRINGS[24/*"  "*/]);
}
...
void Console::Init(::g::Fuse::Scripting::Context* c)
{
    ...
    uPtr(console)->Item(::STRINGS[25/*"log"*/], uDelegate::New(::TYPES[27/*Fuse.Scripting.Callback*/], (void*)Console__Log_fn));
    console->Item(::STRINGS[26/*"dir"*/], uDelegate::New(::TYPES[27/*Fuse.Scripting.Callback*/], (void*)Console__Dir_fn));
    uPtr(c->GlobalObject())->Item(::STRINGS[27/*"console"*/], console);
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[16/*"null"*/], 1, ::STRINGS[15/*"/Users/Omka...*/], 121);
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[28/*"'"*/], ::g::Uno::Object::ToString(uPtr(__this->Value()))), ::STRINGS[28/*"'"*/]), void();
}
...
// private sealed class Instantiator.CountItem :1129
// {
...
static void Data_build(uType* type)
{
    ...
    ::TYPES[28] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
...
{
    return *__retval = ::g::Fuse::Reactive::IContext::Subscribe(uInterface(uPtr(context), ::TYPES[28/*Fuse.Reactive.IContext*/]), (uObject*)__this, __this->Key(), listener), void();
}

// public override sealed string ToString() :308
void Data__ToString_fn(Data* __this, uString** __retval)
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[29/*"{"*/], __this->Key()), ::STRINGS[30/*"}"*/]), void();
}
...
{
    ::STRINGS[20] = uString::Const("");
    ::STRINGS[31] = uString::Const("Cannot bind '");
    ::STRINGS[32] = uString::Const("' to property '");
    ::STRINGS[33] = uString::Const("'. The observable must contain exactly one ");
    ::STRINGS[34] = uString::Const(".");
    ::STRINGS[35] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.1.1/$.uno");
    ::STRINGS[36] = uString::Const("InvalidListOperation");
    ::STRINGS[37] = uString::Const("TryPushAsMarshalledValue");
    ::STRINGS[38] = uString::Const("number");
    ::STRINGS[39] = uString::Const("string");
    ::STRINGS[40] = uString::Const("value that can be converted to type ");
    ::TYPES[29] = ::g::Fuse::IArray_typeof();
    ...
    type->SetFields(4,
        ...
        ::TYPES[24/*string*/], offsetof(::g::Fuse::Reactive::DataBinding, _registryName), 0,
...
{
    if (::g::Fuse::IArray::Length(uInterface(uPtr(values), ::TYPES[29/*Fuse.IArray*/])) > 0)
        __this->InvalidListOperation();
}
...
void DataBinding__NewValue_fn(DataBinding* __this, uObject* value)
{
    ...
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_subscription), ::TYPES[30/*Uno.IDisposable*/]));
...
{
    if (Parent() != NULL)
        ::g::Fuse::Triggers::BusyTask::SetBusy(Parent(), &_busyTask, 0, ::STRINGS[20/*""*/]);
}
...
{
    ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[31/*"Cannot bind '"*/], Key()), ::STRINGS[32/*"' to proper...*/]), ::g::Uno::UX::Selector__op_Implicit1(uPtr(Target())->Name())), ::STRINGS[33/*"'. The obse...*/]), DataBinding::TypeToJSName(uPtr(Target())->PropertyType())), ::STRINGS[34/*"."*/]), this, ::STRINGS[35/*"/Users/Omka...*/], 200, ::STRINGS[36/*"InvalidList...*/], NULL);
}
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[35/*"/Users/Omka...*/], 421, ::STRINGS[37/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
uString* DataBinding::TypeToJSName(uType* t)
{
    if ((::g::Uno::Type::op_Equality(t, ::TYPES[20/*int*/]) || ::g::Uno::Type::op_Equality(t, ::TYPES[21/*float*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[22/*double*/]))
        return ::STRINGS[38/*"number"*/];

    if (::g::Uno::Type::op_Equality(t, ::TYPES[24/*string*/]))
        return ::STRINGS[39/*"string"*/];

    return ::g::Uno::String::op_Addition2(::STRINGS[40/*"value that ...*/], ::g::Uno::Type::FullName(uPtr(t)));
}
// }

// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.1.1/subscription/$.uno
// -----------------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[29] = uString::Const("{");
    ::STRINGS[41] = uString::Const("} not found in data context");
    ::TYPES[30] = ::g::Uno::IDisposable_typeof();
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
        ::g::Fuse::Node__IDataEnumerator_typeof(), offsetof(DataSubscription_type, interface0),
        ::TYPES[30/*Uno.IDisposable*/], offsetof(DataSubscription_type, interface1),
    ...
    type->SetFields(1,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::DataSubscription, _diag), 0,
...
void DataSubscription::ClearDiagnostic()
{
    if (_diag != NULL)
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_diag), ::TYPES[30/*Uno.IDisposable*/]));
        _diag = NULL;
    }
}
...
void DataSubscription::FindData()
{
    ...
    if (!_isResolved)
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[29/*"{"*/], Key()), ::STRINGS[41/*"} not found...*/]), _origin);
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[16/*"null"*/], 1, ::STRINGS[15/*"/Users/Omka...*/], 99);
...
static void JavaScript__DiagnosticSubject_build(uType* type)
{
    ::TYPES[30] = ::g::Uno::IDisposable_typeof();
    type->SetFields(0,
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::JavaScript__DiagnosticSubject, _diagnostic), 0);
}
...
void JavaScript__DiagnosticSubject::ClearDiagnostic()
{
    if (_diagnostic != NULL)
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_diagnostic), ::TYPES[30/*Uno.IDisposable*/]));
        _diagnostic = NULL;
    }
}
...
// public sealed class Divide :932
// {
...
// public Divide(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) :935
...
// protected override sealed object Compute(object left, object right) :936
...
// public Divide New(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) :935
...
// public override sealed string get_Symbol() :941
void Divide__get_Symbol_fn(Divide* __this, uString** __retval)
{
    return *__retval = ::STRINGS[43/*"/"*/], void();
}

// public Divide(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) [instance] :935
void Divide::ctor_3(::g::Fuse::Reactive::Expression* left, ::g::Fuse::Reactive::Expression* right)
{
    ctor_2(left, right);
}

// public Divide New(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) [static] :935
...
// public object get_Items() [instance] :599
uObject* Each::Items()
{
    return _items;
}

// public void set_Items(object value) [instance] :600
...
// public sealed class Equal :1031
// {
...
// protected override sealed object Compute(object left, object right) :1035
...
// public override sealed string get_Symbol() :1040
...
void JavaScript__EvaluateDataContext::ctor_(::g::Fuse::Reactive::ThreadWorker* worker, ::g::Fuse::Reactive::JavaScript* js)
{
    _js = js;
    _worker = worker;
    uPtr(_worker)->Invoke(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)JavaScript__EvaluateDataContext__Evaluate_fn, this));
}
...
void JavaScript__EvaluateDataContext::Evaluate()
{
    ...
    ::g::Fuse::UpdateManager::PostAction(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)JavaScript__EvaluateDataContext__SetDataContext_fn, this));
}
...
static void EventBinding_build(uType* type)
{
    ...
    type->SetFields(4,
        ::TYPES[37/*Fuse.Reactive.IEventHandler*/], offsetof(::g::Fuse::Reactive::EventBinding, _eventHandler), 0,
...
// internal override sealed void NewValue(object obj) :696
...
// protected override sealed void OnUnrooted() :702
...
// private void ProcessQueuedEvents() :684
void EventBinding__ProcessQueuedEvents_fn(EventBinding* __this)
{
    __this->ProcessQueuedEvents();
}

// private void ProcessQueuedEvents() [instance] :684
...
// public abstract class ExpressionBinding :808
// {
static void ExpressionBinding_build(uType* type)
{
    ...
    ::TYPES[30] = ::g::Uno::IDisposable_typeof();
    ::TYPES[39] = ::g::Fuse::Reactive::IWriteable_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(1,
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::ExpressionBinding, _expressionSub), 0,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::Fuse::Reactive::ExpressionBinding, _nameTable), uFieldFlagsWeak,
        ::TYPES[38/*Fuse.Reactive.IExpression*/], offsetof(::g::Fuse::Reactive::ExpressionBinding, _Key), 0);
}
...
// protected ExpressionBinding(Fuse.Reactive.IExpression key, Uno.UX.NameTable nameTable) :817
...
// private Uno.IDisposable Fuse.Reactive.IContext.Subscribe(Fuse.Reactive.IExpression source, string key, Fuse.Reactive.IListener listener) :834
...
// protected override void OnUnrooted() :846
void ExpressionBinding__OnUnrooted_fn(ExpressionBinding* __this)
{
    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_expressionSub), ::TYPES[30/*Uno.IDisposable*/]));
    __this->_expressionSub = NULL;
    ::g::Fuse::Binding__OnUnrooted_fn(__this);
}

// public virtual Uno.IDisposable SubscribeResource(Fuse.Reactive.IExpression source, string key, Fuse.Reactive.IListener listener) :841
...
// protected internal void WriteBack(object value) :826
void ExpressionBinding__WriteBack_fn(ExpressionBinding* __this, uObject* value)
{
    __this->WriteBack(value);
}

// protected ExpressionBinding(Fuse.Reactive.IExpression key, Uno.UX.NameTable nameTable) [instance] :817
...
// protected internal bool get_CanWriteBack() [instance] :825
bool ExpressionBinding::CanWriteBack()
{
    return uIs((uObject*)_expressionSub, ::TYPES[39/*Fuse.Reactive.IWriteable*/]);
}

// public generated Fuse.Reactive.IExpression get_Key() [instance] :810
uObject* ExpressionBinding::Key()
{
    return _Key;
}

// private generated void set_Key(Fuse.Reactive.IExpression value) [instance] :810
void ExpressionBinding::Key(uObject* value)
{
    _Key = value;
}

// public Uno.UX.NameTable get_NameTable() [instance] :814
::g::Uno::UX::NameTable* ExpressionBinding::NameTable()
{
    return _nameTable;
}

// protected internal void WriteBack(object value) [instance] :826
void ExpressionBinding::WriteBack(uObject* value)
{
    ::g::Fuse::Reactive::IWriteable::SetExclusive(uInterface(uPtr(_expressionSub), ::TYPES[39/*Fuse.Reactive.IWriteable*/]), value);
}
// }
...
// public sealed class GreaterOrEqual :1005
// {
...
// protected override sealed object Compute(object left, object right) :1009
...
// public override sealed string get_Symbol() :1015
...
// public sealed class GreaterThan :993
// {
...
// protected override sealed object Compute(object left, object right) :997
...
// public override sealed string get_Symbol() :1002
...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive/1.1.1/$.uno
// -------------------------------------------------------------------------------------------
...
// protected InfixOperator(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) :886
...
// public override sealed string ToString() :890
void InfixOperator__ToString_fn(InfixOperator* __this, uString** __retval)
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[12/*"("*/], __this->Left()), ::STRINGS[48/*" "*/]), __this->Symbol()), ::STRINGS[48/*" "*/]), __this->Right()), ::STRINGS[10/*")"*/]), void();
}

// protected InfixOperator(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) [instance] :886
...
// public abstract class InnerListener :1428
// {
static void InnerListener_build(uType* type)
{
    ::TYPES[30] = ::g::Uno::IDisposable_typeof();
    ::TYPES[40] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Fuse::Reactive::IExpression_typeof(), InnerListener__ObservableSubscription_typeof(), NULL);
    ::TYPES[32] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[41] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Reactive::IExpression_typeof(), InnerListener__ObservableSubscription_typeof(), NULL);
    type->SetInterfaces(
        ::TYPES[30/*Uno.IDisposable*/], offsetof(InnerListener_type, interface0),
        ::g::Fuse::Reactive::IListener_typeof(), offsetof(InnerListener_type, interface1));
    type->SetFields(0,
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::InnerListener, _diag), 0,
        ::TYPES[41/*Uno.Collections.Dictionary<Fuse.Reactive.IExpression, Fuse.Reactive.InnerListener.ObservableSubscription>*/], offsetof(::g::Fuse::Reactive::InnerListener, _obsSubs), 0);
}
...
void InnerListener__Dispose_fn(InnerListener* __this)
{
    ...
    {
        for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong<InnerListener__ObservableSubscription*> > enum1 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(__this->_obsSubs)->Values()), &ret2), ret2); enum1.MoveNext(::TYPES[40/*Uno.Collections.Dictionary<Fuse.Reactive.IExpression, Fuse.Reactive.InnerListener.ObservableSubscription>.ValueCollection.Enumerator*/]); )
        {
            InnerListener__ObservableSubscription* k = enum1.Current(::TYPES[40/*Uno.Collections.Dictionary<Fuse.Reactive.IExpression, Fuse.Reactive.InnerListener.ObservableSubscription>.ValueCollection.Enumerator*/]);
            uPtr(k)->Dispose();
        }
...
// private void Fuse.Reactive.IListener.OnNewData(Fuse.Reactive.IExpression source, object value) :1463
void InnerListener__FuseReactiveIListenerOnNewData_fn(InnerListener* __this, uObject* source, uObject* value)
{
    ...
    {
        if (__this->_obsSubs == NULL)
            __this->_obsSubs = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[41/*Uno.Collections.Dictionary<Fuse.Reactive.IExpression, Fuse.Reactive.InnerListener.ObservableSubscription>*/]));
...
// public void SetDiagnostic(string message, Fuse.Reactive.IExpression source) :1434
...
// protected generated InnerListener() [instance] :1428
void InnerListener::ctor_()
{
}

// public void ClearDiagnostic() [instance] :1440
...
// public void SetDiagnostic(string message, Fuse.Reactive.IExpression source) [instance] :1434
...
{
    ::STRINGS[49] = uString::Const("Template contains a non-Node");
    ::STRINGS[35] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.1.1/$.uno");
    ::STRINGS[50] = uString::Const("AddTemplate");
    ::STRINGS[20] = uString::Const("");
    ::STRINGS[51] = uString::Const("Limit cannot be less than 0");
    ::STRINGS[52] = uString::Const("set_Limit");
    ::STRINGS[53] = uString::Const("Offset cannot be less than 0");
    ::STRINGS[54] = uString::Const("set_Offset");
    ::TYPES[42] = ::g::Uno::Collections::List_typeof()->MakeType(Instantiator__WindowItem_typeof(), NULL);
    ::TYPES[43] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), uObject_typeof(), NULL);
    ::TYPES[44] = ::g::Fuse::Node_typeof();
    ::TYPES[32] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[45] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[44/*Fuse.Node*/], NULL);
    ::TYPES[46] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[47] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[48] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*IndexOf<Fuse.Node>*/, ::TYPES[44/*Fuse.Node*/], NULL);
    ::TYPES[49] = Instantiator__ObservableLink_typeof();
    ...
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[30] = ::g::Uno::IDisposable_typeof();
    ::TYPES[52] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[53] = ::g::Uno::Action1_typeof()->MakeType(::TYPES[44/*Fuse.Node*/], NULL);
    ::TYPES[54] = ::g::Uno::Collections::RootableList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(12,
        ...
        ::TYPES[53/*Uno.Action<Fuse.Node>*/], offsetof(::g::Fuse::Reactive::Instantiator, _completedRemove), 0,
        ::TYPES[43/*Uno.Collections.Dictionary<Fuse.Node, object>*/], offsetof(::g::Fuse::Reactive::Instantiator, _dataMap), 0,
        ...
        ::TYPES[24/*string*/], offsetof(::g::Fuse::Reactive::Instantiator, _matchKey), 0,
        ...
        ::TYPES[54/*Uno.Collections.RootableList<Uno.UX.Template>*/], offsetof(::g::Fuse::Reactive::Instantiator, _rootTemplates), 0,
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::Instantiator, _subscription), 0,
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL), offsetof(::g::Fuse::Reactive::Instantiator, _templates), 0,
        ::TYPES[42/*Uno.Collections.List<Fuse.Reactive.Instantiator.WindowItem>*/], offsetof(::g::Fuse::Reactive::Instantiator, _windowItems), 0,
        ::TYPES[24/*string*/], offsetof(::g::Fuse::Reactive::Instantiator, _TemplateKey), 0,
        ::g::Fuse::Visual_typeof(), offsetof(::g::Fuse::Reactive::Instantiator, _TemplateSource), 0,
        ::TYPES[14/*Uno.Action*/], offsetof(::g::Fuse::Reactive::Instantiator, UpdatedWindowItems1), 0);
}
...
// protected internal Instantiator() :894
void Instantiator__ctor_3_fn(Instantiator* __this)
{
    __this->ctor_3();
}

// private void AddTemplate(object data, Uno.UX.Template f, Uno.Collections.List<Fuse.Node> newElements) :1632
...
// private void CompletedRemove(Fuse.Node n) :1427
void Instantiator__CompletedRemove_fn(Instantiator* __this, ::g::Fuse::Node* n)
{
    __this->CompletedRemove(n);
}

// private void CompleteWindowItem(Fuse.Reactive.Instantiator.WindowItem wi, int windowIndex) :1546
...
// private bool CompleteWindowItems(bool one) :1525
...
// private void Fuse.ITemplateObserver.OnTemplatesChangedWileRooted() :994
void Instantiator__FuseITemplateObserverOnTemplatesChangedWileRooted_fn(Instantiator* __this)
{
    __this->Repopulate();
}

// private object Fuse.Node.ISubtreeDataProvider.GetData(Fuse.Node n) :1254
void Instantiator__FuseNodeISubtreeDataProviderGetData_fn(Instantiator* __this, ::g::Fuse::Node* n, uObject** __retval)
{
    ...
    {
        Instantiator__ObservableLink* ol = uAs<Instantiator__ObservableLink*>(v, ::TYPES[49/*Fuse.Reactive.Instantiator.ObservableLink*/]);

        if (ol != NULL)
            return *__retval = uPtr(ol)->Data(), void();

        if (!uIs(v, ::TYPES[50/*Fuse.Reactive.Instantiator.CountItem*/]))
...
// private void Fuse.Reactive.IObserver.OnAdd(object addedValue) :1320
...
// private void Fuse.Reactive.IObserver.OnClear() :1383
...
// private void Fuse.Reactive.IObserver.OnFailed(string message) :1312
...
// private void Fuse.Reactive.IObserver.OnInsertAt(int index, object value) :1356
...
// private void Fuse.Reactive.IObserver.OnNewAll(Fuse.IArray values) :1374
...
// private void Fuse.Reactive.IObserver.OnNewAt(int index, object value) :1365
...
// private void Fuse.Reactive.IObserver.OnRemoveAt(int index) :1328
...
// private void Fuse.Reactive.IObserver.OnSet(object newValue) :1303
...
// internal override sealed Fuse.Node GetLastNodeInGroup() :1655
...
void Instantiator__OnRooted_fn(Instantiator* __this)
{
    ...
    if (__this->_rootTemplates != NULL)
        uPtr(__this->_rootTemplates)->Subscribe(uDelegate::New(::TYPES[52/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, __this), uDelegate::New(::TYPES[52/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, __this));
}

// private void OnTemplatesChanged(Uno.UX.Template factory) :999
...
// protected internal Instantiator() [instance] :894
void Instantiator::ctor_3()
{
    _defer = 1;
    _deferredPriority = 0.0f;
    _windowItems = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[42/*Uno.Collections.List<Fuse.Reactive.Instantiator.WindowItem>*/]));
    _dataMap = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[43/*Uno.Collections.Dictionary<Fuse.Node, object>*/]));
    ctor_2();
}

// private void AddTemplate(object data, Uno.UX.Template f, Uno.Collections.List<Fuse.Node> newElements) [instance] :1632
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ::g::Fuse::Node* elm = uAs< ::g::Fuse::Node*>(uPtr(f)->New1(), ::TYPES[44/*Fuse.Node*/]);

    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[49/*"Template co...*/], this, ::STRINGS[35/*"/Users/Omka...*/], 1637, ::STRINGS[50/*"AddTemplate"*/]);
        return;
    }

    uObject* obs = uAs<uObject*>(data, ::TYPES[32/*Fuse.Reactive.IObservable*/]);
...
// private void CompletedRemove(Fuse.Node n) [instance] :1427
...
// private void CompleteWindowItem(Fuse.Reactive.Instantiator.WindowItem wi, int windowIndex) [instance] :1546
void Instantiator::CompleteWindowItem(Instantiator__WindowItem* wi, int windowIndex)
{
    ...
    ::g::Uno::Collections::List* newElements = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[45/*Uno.Collections.List<Fuse.Node>*/]);
    ...
    if (!anyMatched)
    {
        ...
        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Templates()), ::TYPES[46/*Uno.Collections.IEnumerable<Uno.UX.Template>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[8/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::UX::Template* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[47/*Uno.Collections.IEnumerator<Uno.UX.Template>*/]), &ret6), ret6);
    ...
    uPtr(Parent())->InsertNodes((::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[48/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(Parent())->Children(), lastNode, &ret7), ret7) + 1, uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[44/*Fuse.Node*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(newElements, &ret8), ret8)));
}

// private bool CompleteWindowItems(bool one) [instance] :1525
...
// private void CompleteWindowItemsAction() [instance] :1519
...
// public Fuse.Reactive.InstanceDefer get_Defer() [instance] :925
int Instantiator::Defer()
{
    return _defer;
}

// public void set_Defer(Fuse.Reactive.InstanceDefer value) [instance] :926
void Instantiator::Defer(int value)
{
    _defer = value;
}

// public float get_DeferredPriority() [instance] :937
float Instantiator::DeferredPriority()
{
    return _deferredPriority;
}

// public void set_DeferredPriority(float value) [instance] :938
void Instantiator::DeferredPriority(float value)
{
    _deferredPriority = value;
}

// private object GetData(int dataIndex) [instance] :1230
uObject* Instantiator::GetData(int dataIndex)
{
    ...
    uObject* a = uAs<uObject*>(_items, ::TYPES[29/*Fuse.IArray*/]);

    if (a != NULL)
        return ::g::Fuse::IArray::Item(uInterface(uPtr(a), ::TYPES[29/*Fuse.IArray*/]), dataIndex);

    return NULL;
}

// private int GetDataCount() [instance] :1241
int Instantiator::GetDataCount()
{
    ...
    if (a != NULL)
        return ::g::Fuse::IArray::Length(uInterface(uPtr(a), ::TYPES[29/*Fuse.IArray*/]));

    return 0;
}

// private Fuse.Node GetLastNodeFromIndex(int windowIndex) [instance] :1660
...
// private string GetMatchKey(object data) [instance] :1471
uString* Instantiator::GetMatchKey(uObject* data)
{
    ...
    {
        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(so), ::TYPES[51/*Fuse.IObject*/]), _matchKey))
            return uAs<uString*>(::g::Fuse::IObject::Item(uInterface(uPtr(so), ::TYPES[51/*Fuse.IObject*/]), _matchKey), ::TYPES[24/*string*/]);
    }

    return NULL;
}

// internal bool get_HasLimit() [instance] :1125
bool Instantiator::HasLimit()
{
    return _hasLimit;
}

// private void InsertNew(int dataIndex) [instance] :1487
void Instantiator::InsertNew(int dataIndex)
{
    ...
    else if (!_pendingNew)
    {
        if (Defer() == 2)
            ...
            ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)Instantiator__CompleteWindowItemsAction_fn, this), -1, 0);
...
// internal int get_Limit() [instance] :1083
int Instantiator::Limit()
{
    return _limit;
}

// internal void set_Limit(int value) [instance] :1084
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"Limit canno...*/], this, ::STRINGS[35/*"/Users/Omka...*/], 1091, ::STRINGS[52/*"set_Limit"*/], NULL);
        value = 0;
    }
...
// internal int get_Offset() [instance] :1035
int Instantiator::Offset()
{
    return _offset;
}

// internal void set_Offset(int value) [instance] :1036
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[53/*"Offset cann...*/], this, ::STRINGS[35/*"/Users/Omka...*/], 1043, ::STRINGS[54/*"set_Offset"*/], NULL);
        value = 0;
    }
...
// protected internal void OnItemsChanged() [instance] :1151
void Instantiator::OnItemsChanged()
{
    ...
    if (obs != NULL)
    {
        if (_subscription != NULL)
            ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_subscription), ::TYPES[30/*Uno.IDisposable*/]));
...
// private void OnTemplatesChanged(Uno.UX.Template factory) [instance] :999
...
// private void OnUpdatedWindowItems() [instance] :1197
void Instantiator::OnUpdatedWindowItems()
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)Instantiator__PostUpdatedWindowItems_fn, this), -1, 0);
}

// private void PostUpdatedWindowItems() [instance] :1207
...
// private void RemoveAll() [instance] :1400
...
// private void RemoveAt(int dataIndex) [instance] :1338
...
// private void RemoveFromParent(Fuse.Node n) [instance] :1420
void Instantiator::RemoveFromParent(::g::Fuse::Node* n)
{
    if (::g::Uno::Delegate::op_Equality(_completedRemove, NULL))
        _completedRemove = uDelegate::New(::TYPES[53/*Uno.Action<Fuse.Node>*/], (void*)Instantiator__CompletedRemove_fn, this);

    uPtr(Parent())->BeginRemoveChild(n, _completedRemove);
}

// private void ReplaceAll(object[] dcs) [instance] :1392
...
// private void Repopulate() [instance] :1271
void Instantiator::Repopulate()
{
    ...
    else if (a != NULL)
    {
        ...
        for (int i = 0; i < ::g::Fuse::IArray::Length(uInterface(uPtr(a), ::TYPES[29/*Fuse.IArray*/])); i++)
            InsertNew(i);
    }
}

// private void SetFailed(string message) [instance] :1295
...
// private void SetValid() [instance] :1289
...
// public generated string get_TemplateKey() [instance] :991
uString* Instantiator::TemplateKey()
{
    return _TemplateKey;
}

// public generated void set_TemplateKey(string value) [instance] :991
void Instantiator::TemplateKey(uString* value)
{
    _TemplateKey = value;
}

// public Uno.Collections.IList<Uno.UX.Template> get_Templates() [instance] :905
uObject* Instantiator::Templates()
{
    if (_templates != NULL)
        return _templates;

    _rootTemplates = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::TYPES[54/*Uno.Collections.RootableList<Uno.UX.Template>*/]));

    if (IsRootingCompleted())
        uPtr(_rootTemplates)->Subscribe(uDelegate::New(::TYPES[52/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, this), uDelegate::New(::TYPES[52/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, this));

    _templates = (uObject*)_rootTemplates;
    return _templates;
}

// public generated Fuse.Visual get_TemplateSource() [instance] :980
::g::Fuse::Visual* Instantiator::TemplateSource()
{
    return _TemplateSource;
}

// public generated void set_TemplateSource(Fuse.Visual value) [instance] :980
void Instantiator::TemplateSource(::g::Fuse::Visual* value)
{
    _TemplateSource = value;
}

// private void TrimAndPad() [instance] :1102
...
// internal generated void add_UpdatedWindowItems(Uno.Action value) [instance] :1195
...
// internal generated void remove_UpdatedWindowItems(Uno.Action value) [instance] :1195
...
{
    ::STRINGS[55] = uString::Const("exports");
    ::STRINGS[56] = uString::Const("JavaScript error in ");
    ::STRINGS[57] = uString::Const(" fixed!");
    ::STRINGS[6] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.1.1/$.uno");
    ::STRINGS[58] = uString::Const("EvaluateModule");
    ::STRINGS[59] = uString::Const("JavaScript error");
    ::STRINGS[60] = uString::Const("Cannot require() a rooted module");
    ::STRINGS[61] = uString::Const(" in ");
    ::STRINGS[62] = uString::Const(" line ");
    ::TYPES[30] = ::g::Uno::IDisposable_typeof();
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[55] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[56] = ::g::Uno::UX::Resource_typeof()->MakeMethod(0/*GetGlobalsOfType<Fuse.Scripting.NativeModule>*/, ::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[57] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[32] = ::g::Fuse::Reactive::IObservable_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(12,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::JavaScript, _sub), 0,
...
void JavaScript__FuseScriptingIModuleProviderGetModule_fn(JavaScript* __this, ::g::Fuse::Scripting::Module** __retval)
{
    if (__this->IsRootingCompleted())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[60/*"Cannot requ...*/]));
...
void JavaScript__OnUnrooted_fn(JavaScript* __this)
{
    ...
    if ((--JavaScript::_javaScriptCounter()) <= 0)
    {
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr((uObject*)::g::Uno::UX::Resource::GetGlobalsOfType(::TYPES[56/*Uno.UX.Resource.GetGlobalsOfType<Fuse.Scripting.NativeModule>*/])), ::TYPES[55/*Uno.Collections.IEnumerable<Fuse.Scripting.NativeModule>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[8/*Uno.Collections.IEnumerator*/])); )
        {
...
void JavaScript::DisposeSubscription()
{
    if (_sub != NULL)
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_sub), ::TYPES[30/*Uno.IDisposable*/]));
        _sub = NULL;
    }
}
...
uObject* JavaScript::EvaluateExports()
{
    ...
    if (_moduleResult != NULL)
        return uPtr(uPtr(_moduleResult)->Object)->Item(::STRINGS[55/*"exports"*/]);
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        uPtr(newModuleResult)->AddDependency(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)JavaScript__DispatchEvaluate_fn, this));

        if (newModuleResult->Error() == NULL)
        {
            _moduleResult = newModuleResult;

            if (::g::Uno::String::op_Equality(JavaScript::previousErrorFile(), ::g::Uno::String::op_Addition1(FileName(), uBox<int>(::TYPES[20/*int*/], LineNumber()))))
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[56/*"JavaScript ...*/], FileName()), ::STRINGS[57/*" fixed!"*/]), this, ::STRINGS[6/*"/Users/Omka...*/], 450, ::STRINGS[58/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                JavaScript::UserScriptError(::STRINGS[59/*"JavaScript ...*/], se, this, ::STRINGS[6/*"/Users/Omka...*/], 466, ::STRINGS[58/*"EvaluateMod...*/]);
                JavaScript::previousErrorFile() = ::g::Uno::String::op_Addition1(FileName(), uBox<int>(::TYPES[20/*int*/], LineNumber()));
            }
        }
    }
}
...
void JavaScript::UserScriptError(uString* msg, ::g::Fuse::Scripting::ScriptException* ex, uObject* obj, uString* filePath, int lineNumber, uString* memberName)
{
    ...
    msg = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(msg, ::STRINGS[61/*" in "*/]), uPtr(ex)->FileName()), ::STRINGS[62/*" line "*/]), uBox<int>(::TYPES[20/*int*/], uPtr(ex)->LineNumber()));
...
// public sealed class Lerp :733
// {
static void Lerp_build(uType* type)
{
    ::STRINGS[63] = uString::Const("lerp(");
    ::STRINGS[9] = uString::Const(",");
    ::STRINGS[10] = uString::Const(")");
    ::TYPES[12] = ::g::Fuse::Marshal_typeof()->MakeMethod(1/*TryToType<float>*/, ::g::Uno::Float_typeof(), NULL);
    type->SetInterfaces(
...
// protected override sealed object Compute(object a, object b, object t) :741
void Lerp__Compute_fn(Lerp* __this, uObject* a, uObject* b, uObject* t, uObject** __retval)
{
    ...
    switch (size)
    {
        ...
        case 2:
            return *__retval = uBox(::TYPES[84/*float2*/], ::g::Uno::Math::Lerp2(::g::Uno::Float2__New2(av.X, av.Y), ::g::Uno::Float2__New2(bv.X, bv.Y), tv)), void();
        case 3:
            return *__retval = uBox(::TYPES[85/*float3*/], ::g::Uno::Math::Lerp4(::g::Uno::Float3__New2(av.X, av.Y, av.Z), ::g::Uno::Float3__New2(bv.X, bv.Y, bv.Z), tv)), void();
        case 4:
            return *__retval = uBox(::TYPES[86/*float4*/], ::g::Uno::Math::Lerp6(av, bv, tv)), void();
    }

    return *__retval = NULL, void();
}

// public override sealed string ToString() :766
void Lerp__ToString_fn(Lerp* __this, uString** __retval)
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[63/*"lerp("*/], __this->First()), ::STRINGS[9/*","*/]), __this->Second()), ::STRINGS[9/*","*/]), __this->Third()), ::STRINGS[10/*")"*/]), void();
}
// }
...
// public sealed class LessOrEqual :1018
// {
...
// protected override sealed object Compute(object left, object right) :1022
...
// public override sealed string get_Symbol() :1028
...
// public sealed class LessThan :981
// {
...
// protected override sealed object Compute(object left, object right) :985
...
// public override sealed string get_Symbol() :990
...
// public sealed class LogicalAnd :1056
// {
...
// public LogicalAnd(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) :1059
void LogicalAnd__ctor_3_fn(LogicalAnd* __this, ::g::Fuse::Reactive::Expression* left, ::g::Fuse::Reactive::Expression* right)
{
    __this->ctor_3(left, right);
}

// protected override sealed object Compute(object left, object right) :1060
...
// public LogicalAnd New(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) :1059
...
// public override sealed string get_Symbol() :1066
void LogicalAnd__get_Symbol_fn(LogicalAnd* __this, uString** __retval)
{
    return *__retval = ::STRINGS[66/*"&&"*/], void();
}

// public LogicalAnd(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) [instance] :1059
void LogicalAnd::ctor_3(::g::Fuse::Reactive::Expression* left, ::g::Fuse::Reactive::Expression* right)
{
    ctor_2(left, right);
}

// public LogicalAnd New(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) [static] :1059
...
// public sealed class LogicalOr :1069
// {
...
// protected override sealed object Compute(object left, object right) :1073
...
// public override sealed string get_Symbol() :1079
...
static void ThreadWorker__MethodClosure_build(uType* type)
{
    ...
    ::TYPES[25] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[27] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[58] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[26] = ::g::Fuse::Scripting::Array_typeof();
    type->SetFields(0,
...
void ThreadWorker__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _m = m;
    _worker = worker;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[68/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[69/*"(function (...*/], uPtr(m)->Name), ::STRINGS[70/*" = function...*/])), ::TYPES[25/*Fuse.Scripting.Function*/]);
    uPtr(factory)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, cl, uDelegate::New(::TYPES[27/*Fuse.Scripting.Callback*/], (void*)ThreadWorker__MethodClosure__Callback_fn, this)));
}

// private object Callback(object[] args) [instance] :1618
uObject* ThreadWorker__MethodClosure::Callback(uArray* args)
{
    uObject* self = uPtr(uCast< ::g::Fuse::Scripting::External*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[58/*Fuse.Scripting.External*/]))->Object;
...
// public sealed class Multiply :920
// {
...
// public Multiply(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) :923
void Multiply__ctor_3_fn(Multiply* __this, ::g::Fuse::Reactive::Expression* left, ::g::Fuse::Reactive::Expression* right)
{
    __this->ctor_3(left, right);
}

// protected override sealed object Compute(object left, object right) :924
...
// public Multiply New(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) :923
...
// public override sealed string get_Symbol() :929
void Multiply__get_Symbol_fn(Multiply* __this, uString** __retval)
{
    return *__retval = ::STRINGS[71/*"*"*/], void();
}

// public Multiply(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) [instance] :923
void Multiply::ctor_3(::g::Fuse::Reactive::Expression* left, ::g::Fuse::Reactive::Expression* right)
{
    ctor_2(left, right);
}

// public Multiply New(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) [static] :923
...
{
    ::STRINGS[72] = uString::Const("Named object not found: ");
    ::TYPES[28] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
    type->SetFields(0,
...
{
    if (::g::Fuse::Reactive::IContext::NameTable(uInterface(uPtr(context), ::TYPES[28/*Fuse.Reactive.IContext*/])) != NULL)
    {
        uObject* obj = uPtr(::g::Fuse::Reactive::IContext::NameTable(uInterface(uPtr(context), ::TYPES[28/*Fuse.Reactive.IContext*/])))->Item(__this->Identifier());

        if (obj != NULL)
            return *__retval = obj, void();
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[72/*"Named objec...*/], __this->Identifier())));
}
...
{
    ::TYPES[59] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Reactive::Observable__Subscription_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Reactive::Observable__Subscription_typeof(), NULL);
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    type->SetFields(2,
...
void Observable__NewAll__OnPerform_fn(Observable__NewAll* __this, uObject* sub)
{
    ...
    uPtr(__this->Observable())->UnsubscribeValues();
    uPtr(uPtr(__this->Observable())->_values)->Clear();
    uPtr(uPtr(__this->Observable())->_values)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[59/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<object>*/], uPtr(__this->_newValues)->ItemsReadonly())));
...
// public sealed class NotEqual :1043
// {
...
// public NotEqual(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) :1046
void NotEqual__ctor_3_fn(NotEqual* __this, ::g::Fuse::Reactive::Expression* left, ::g::Fuse::Reactive::Expression* right)
{
    __this->ctor_3(left, right);
}

// protected override sealed object Compute(object left, object right) :1047
...
// public NotEqual New(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) :1046
...
// public override sealed string get_Symbol() :1053
void NotEqual__get_Symbol_fn(NotEqual* __this, uString** __retval)
{
    return *__retval = ::STRINGS[73/*"!="*/], void();
}

// public NotEqual(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) [instance] :1046
void NotEqual::ctor_3(::g::Fuse::Reactive::Expression* left, ::g::Fuse::Reactive::Expression* right)
{
    ctor_2(left, right);
}

// public NotEqual New(Fuse.Reactive.Expression left, Fuse.Reactive.Expression right) [static] :1046
...
// public sealed class NullCoalesce :944
// {
...
// protected override sealed object Compute(object left, object right) :951
...
{
    ::TYPES[60] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[61] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[4] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ::TYPES[10] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[62] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
        ::g::Fuse::IRaw_typeof(), offsetof(ObjectMirror_type, interface0),
        ::g::Fuse::IObject_typeof(), offsetof(ObjectMirror_type, interface1));
    type->SetFields(1,
        ::TYPES[60/*Uno.Collections.Dictionary<string, object>*/], offsetof(::g::Fuse::Reactive::ObjectMirror, _props), 0);
}
...
void ObjectMirror__Unsubscribe_fn(ObjectMirror* __this)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->_props), &ret4), ret4); enum1.MoveNext(::TYPES[61/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > p = enum1.Current(::TYPES[61/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
...
{
    _props = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[60/*Uno.Collections.Dictionary<string, object>*/]));
    ctor_(obj);
...
{
    return (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[62/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], (uObject*)((::g::Uno::Collections::Dictionary__KeyCollection*)uPtr(_props)->Keys()));
}
...
{
    ::STRINGS[75] = uString::Const("addSubscriber");
    ::STRINGS[76] = uString::Const("set");
    ::STRINGS[77] = uString::Const("clear");
    ::STRINGS[78] = uString::Const("newAt");
    ::STRINGS[79] = uString::Const("newAll");
    ::STRINGS[80] = uString::Const("add");
    ::STRINGS[81] = uString::Const("removeAt");
    ::STRINGS[82] = uString::Const("insertAt");
    ::STRINGS[83] = uString::Const("removeRange");
    ::STRINGS[84] = uString::Const("insertAll");
    ::STRINGS[85] = uString::Const("failed");
    ::STRINGS[86] = uString::Const("Unhandled observable operation: ");
    ::STRINGS[87] = uString::Const("removeSubscriber");
    ::TYPES[63] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[64] = ::g::Uno::Collections::List_typeof()->MakeType(Observable__Subscription_typeof(), NULL);
    ::TYPES[27] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[16] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[24] = ::g::Uno::String_typeof();
    ::TYPES[65] = ::g::Fuse::Reactive::ArrayMirror_typeof();
    ::TYPES[20] = ::g::Uno::Int_typeof();
    ::TYPES[22] = ::g::Uno::Double_typeof();
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[4] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ...
    type->SetFields(1,
        ...
        ::TYPES[16/*Fuse.Scripting.Object*/], offsetof(::g::Fuse::Reactive::Observable, _observable), 0,
        ::g::Fuse::Scripting::Function_typeof(), offsetof(::g::Fuse::Reactive::Observable, _observeChange), 0,
        ::TYPES[64/*Uno.Collections.List<Fuse.Reactive.Observable.Subscription>*/], offsetof(::g::Fuse::Reactive::Observable, _observers), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Reactive::Observable, _usingObservers), 0,
        ::TYPES[63/*Uno.Collections.List<object>*/], offsetof(::g::Fuse::Reactive::Observable, _values), 0,
...
{
    _values = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[63/*Uno.Collections.List<object>*/]));
    _observers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[64/*Uno.Collections.List<Fuse.Reactive.Observable.Subscription>*/]));
    ctor_1(obj);
    _worker = worker;
    _observable = obj;
    ...
    uPtr(obj)->CallMethod(::STRINGS[75/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[23/*bool*/], supressCallback)));
}
...
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[79/*"newAll"*/]))
        uPtr(_worker)->Enqueue(Observable__NewAll::New1(this, uCast< ::g::Fuse::Reactive::ArrayMirror*>(uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(3)), ::TYPES[65/*Fuse.Reactive.ArrayMirror*/]), origin));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[80/*"add"*/]))
        uPtr(_worker)->Enqueue(Observable__Add::New1(this, uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(3))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[81/*"removeAt"*/]))
        uPtr(_worker)->Enqueue(Observable__RemoveAt::New1(this, ToInt(uPtr(args)->Strong<uObject*>(3))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[82/*"insertAt"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[83/*"removeRange"*/]))
        uPtr(_worker)->Enqueue(Observable__RemoveRange::New1(this, ToInt(uPtr(args)->Strong<uObject*>(3)), ToInt(uPtr(args)->Strong<uObject*>(4))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[84/*"insertAll"*/]))
        uPtr(_worker)->Enqueue(Observable__InsertAll::New1(this, ToInt(uPtr(args)->Strong<uObject*>(3)), uCast< ::g::Fuse::Reactive::ArrayMirror*>(uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(4)), ::TYPES[65/*Fuse.Reactive.ArrayMirror*/])));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[85/*"failed"*/]))
        uPtr(_worker)->Enqueue(Observable__Failed::New1(this, uAs<uString*>(uPtr(args)->Strong<uObject*>(3), ::TYPES[24/*string*/])));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[86/*"Unhandled o...*/], op)));
...
{
    uPtr(_observable)->CallMethod(::STRINGS[87/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}
...
{
    return Observable::New1(worker, uCast< ::g::Fuse::Scripting::Object*>(uPtr(uPtr(uPtr(worker)->Context())->Observable())->Call(uArray::New(::TYPES[3/*object[]*/], 0)), ::TYPES[16/*Fuse.Scripting.Object*/]), true);
}
...
// private sealed class Instantiator.ObservableLink :1599
// {
...
// public ObservableLink(Fuse.Reactive.IObservable obs, Fuse.Node target) :1603
...
// public ObservableLink New(Fuse.Reactive.IObservable obs, Fuse.Node target) :1603
...
// protected override sealed void PushData(object newData) :1619
...
// public ObservableLink(Fuse.Reactive.IObservable obs, Fuse.Node target) [instance] :1603
...
// public object get_Data() [instance] :1617
uObject* Instantiator__ObservableLink::Data()
{
    return _currentData;
}

// public ObservableLink New(Fuse.Reactive.IObservable obs, Fuse.Node target) [static] :1603
...
static void ObservableProperty_build(uType* type)
{
    ...
    ::TYPES[30] = ::g::Uno::IDisposable_typeof();
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[66] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetInterfaces(
...
{
    if (::g::Fuse::IArray::Length(uInterface(uPtr(values), ::TYPES[29/*Fuse.IArray*/])) == 1)
        __this->Set(::g::Fuse::IArray::Item(uInterface(uPtr(values), ::TYPES[29/*Fuse.IArray*/]), 0));
}
...
void ObservableProperty__UnoUXIPropertyListenerOnPropertyChanged_fn(ObservableProperty* __this, ::g::Uno::UX::PropertyObject* obj, ::g::Uno::UX::Selector* prop)
{
    ...
    uPtr(__this->_worker)->Invoke(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)ObservableProperty__PushCapture__Run_fn, ObservableProperty__PushCapture::New1(uDelegate::New(::TYPES[66/*Uno.Action<object>*/], (void*)ObservableProperty__PushValue_fn, __this), uPtr(__this->_property)->GetAsObject1())));
}
...
// private sealed class InnerListener.ObservableSubscription :1484
// {
...
// public ObservableSubscription(Fuse.Reactive.IExpression source, Fuse.Reactive.IObservable obs, Fuse.Reactive.InnerListener listener) :1489
...
// public override sealed void Dispose() :1496
...
// public ObservableSubscription New(Fuse.Reactive.IExpression source, Fuse.Reactive.IObservable obs, Fuse.Reactive.InnerListener listener) :1489
...
// protected override sealed void PushData(object newValue) :1503
...
// public ObservableSubscription(Fuse.Reactive.IExpression source, Fuse.Reactive.IObservable obs, Fuse.Reactive.InnerListener listener) [instance] :1489
...
// public ObservableSubscription New(Fuse.Reactive.IExpression source, Fuse.Reactive.IObservable obs, Fuse.Reactive.InnerListener listener) [static] :1489
...
// public sealed class Property :1093
// {
static void Property_build(uType* type)
{
    ::TYPES[67] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::Expression_type, interface0));
    type->SetFields(0,
...
// public Property(Fuse.Reactive.ConstantExpression obj, Uno.UX.PropertyAccessor accessor) :1099
...
// public generated Uno.UX.PropertyAccessor get_Accessor() :1096
void Property__get_Accessor_fn(Property* __this, ::g::Uno::UX::PropertyAccessor** __retval)
{
    *__retval = __this->Accessor();
}

// private generated void set_Accessor(Uno.UX.PropertyAccessor value) :1096
void Property__set_Accessor_fn(Property* __this, ::g::Uno::UX::PropertyAccessor* value)
{
    __this->Accessor(value);
}

// public Property New(Fuse.Reactive.ConstantExpression obj, Uno.UX.PropertyAccessor accessor) :1099
...
// public generated Fuse.Reactive.ConstantExpression get_Object() :1095
void Property__get_Object_fn(Property* __this, ::g::Fuse::Reactive::ConstantExpression** __retval)
{
    *__retval = __this->Object();
}

// private generated void set_Object(Fuse.Reactive.ConstantExpression value) :1095
void Property__set_Object_fn(Property* __this, ::g::Fuse::Reactive::ConstantExpression* value)
{
    __this->Object(value);
}

// public override sealed Uno.IDisposable Subscribe(Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1104
void Property__Subscribe_fn(Property* __this, uObject* context, uObject* listener, uObject** __retval)
{
    ::g::Uno::UX::PropertyObject* obj = uCast< ::g::Uno::UX::PropertyObject*>(uPtr(__this->Object())->GetValue(context), ::TYPES[67/*Uno.UX.PropertyObject*/]);
    return *__retval = (uObject*)Property__Subscription::New1(__this, obj, __this->Accessor(), listener), void();
}

// public Property(Fuse.Reactive.ConstantExpression obj, Uno.UX.PropertyAccessor accessor) [instance] :1099
...
// public generated Uno.UX.PropertyAccessor get_Accessor() [instance] :1096
::g::Uno::UX::PropertyAccessor* Property::Accessor()
{
    return _Accessor;
}

// private generated void set_Accessor(Uno.UX.PropertyAccessor value) [instance] :1096
void Property::Accessor(::g::Uno::UX::PropertyAccessor* value)
{
    _Accessor = value;
}

// public generated Fuse.Reactive.ConstantExpression get_Object() [instance] :1095
::g::Fuse::Reactive::ConstantExpression* Property::Object()
{
    return _Object;
}

// private generated void set_Object(Fuse.Reactive.ConstantExpression value) [instance] :1095
void Property::Object(::g::Fuse::Reactive::ConstantExpression* value)
{
    _Object = value;
}

// public Property New(Fuse.Reactive.ConstantExpression obj, Uno.UX.PropertyAccessor accessor) [static] :1099
...
{
    ::STRINGS[88] = uString::Const("this._raw_");
    ::STRINGS[89] = uString::Const("this._");
    ::STRINGS[90] = uString::Const(" (ScriptProperty)");
    ::STRINGS[91] = uString::Const("(function(cl, getObservable) { Object.defineProperty(cl.prototype, '");
    ::STRINGS[92] = uString::Const("', ");
    ::STRINGS[29] = uString::Const("{");
    ::STRINGS[93] = uString::Const("get: function() { ");
    ::STRINGS[94] = uString::Const("var obs = getObservable(this); ");
    ::STRINGS[95] = uString::Const("if (");
    ::STRINGS[96] = uString::Const(" != obs) {");
    ::STRINGS[97] = uString::Const(" = obs;");
    ::STRINGS[98] = uString::Const(" = obs");
    ::STRINGS[99] = uString::Const(";");
    ::STRINGS[30] = uString::Const("}");
    ::STRINGS[100] = uString::Const("return ");
...
void ThreadWorker__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _worker = worker;
    _p = p;
    uString* rawField = ::g::Uno::String::op_Addition2(::STRINGS[88/*"this._raw_"*/], uPtr(p)->Name);
    uString* propField = ::g::Uno::String::op_Addition2(::STRINGS[89/*"this._"*/], p->Name);
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[90/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[91/*"(function(c...*/], p->Name), ::STRINGS[92/*"', "*/]), ::STRINGS[29/*"{"*/]), ::STRINGS[93/*"get: functi...*/]), ::STRINGS[94/*"var obs = g...*/]), ::STRINGS[95/*"if ("*/]), rawField), ::STRINGS[96/*" != obs) {"*/]), rawField), ::STRINGS[97/*" = obs;"*/]), propField), ::STRINGS[98/*" = obs"*/]), p->Modifier), ::STRINGS[99/*";"*/]), ::STRINGS[30/*"}"*/]), ::STRINGS[100/*"return "*/]), propField), ::STRINGS[30/*"}"*/]), ::STRINGS[101/*"})"*/]), ::STRINGS[101/*"})"*/])), ::TYPES[25/*Fuse.Scripting.Function*/]);
    uPtr(definer)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, cl, uDelegate::New(::TYPES[27/*Fuse.Scripting.Callback*/], (void*)ThreadWorker__PropertyClosure__GetObservable_fn, this)));
}

// private object GetObservable(object[] args) [instance] :1593
uObject* ThreadWorker__PropertyClosure::GetObservable(uArray* args)
{
    ::g::Uno::UX::PropertyObject* obj = uAs< ::g::Uno::UX::PropertyObject*>(::g::Fuse::Reactive::ThreadWorker::Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[67/*Uno.UX.PropertyObject*/]);
...
// public abstract class QuaternaryOperator :1169
// {
...
// private generated void set_Second(Fuse.Reactive.Expression value) :1172
void QuaternaryOperator__set_Second_fn(QuaternaryOperator* __this, ::g::Fuse::Reactive::Expression* value)
{
    __this->Second(value);
}

// public override sealed Uno.IDisposable Subscribe(Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1184
...
// public generated Fuse.Reactive.Expression get_Third() :1173
void QuaternaryOperator__get_Third_fn(QuaternaryOperator* __this, ::g::Fuse::Reactive::Expression** __retval)
{
    *__retval = __this->Third();
}

// private generated void set_Third(Fuse.Reactive.Expression value) :1173
void QuaternaryOperator__set_Third_fn(QuaternaryOperator* __this, ::g::Fuse::Reactive::Expression* value)
{
    __this->Third(value);
}

// public generated Fuse.Reactive.Expression get_First() [instance] :1171
::g::Fuse::Reactive::Expression* QuaternaryOperator::First()
{
    return _First;
}

// private generated void set_First(Fuse.Reactive.Expression value) [instance] :1171
void QuaternaryOperator::First(::g::Fuse::Reactive::Expression* value)
{
    _First = value;
}

// public generated Fuse.Reactive.Expression get_Fourth() [instance] :1174
::g::Fuse::Reactive::Expression* QuaternaryOperator::Fourth()
{
    return _Fourth;
}

// private generated void set_Fourth(Fuse.Reactive.Expression value) [instance] :1174
void QuaternaryOperator::Fourth(::g::Fuse::Reactive::Expression* value)
{
    _Fourth = value;
}

// protected bool get_IsFirstOptional() [instance] :1189
bool QuaternaryOperator::IsFirstOptional()
{
    return false;
}

// protected bool get_IsFourthOptional() [instance] :1192
bool QuaternaryOperator::IsFourthOptional()
{
    return false;
}

// protected bool get_IsSecondOptional() [instance] :1190
bool QuaternaryOperator::IsSecondOptional()
{
    return false;
}

// protected bool get_IsThirdOptional() [instance] :1191
bool QuaternaryOperator::IsThirdOptional()
{
    return false;
}

// public generated Fuse.Reactive.Expression get_Second() [instance] :1172
::g::Fuse::Reactive::Expression* QuaternaryOperator::Second()
{
    return _Second;
}

// private generated void set_Second(Fuse.Reactive.Expression value) [instance] :1172
void QuaternaryOperator::Second(::g::Fuse::Reactive::Expression* value)
{
    _Second = value;
}

// public generated Fuse.Reactive.Expression get_Third() [instance] :1173
::g::Fuse::Reactive::Expression* QuaternaryOperator::Third()
{
    return _Third;
}

// private generated void set_Third(Fuse.Reactive.Expression value) [instance] :1173
...
// public sealed class Resource :1298
// {
...
// public generated string get_Key() :1300
void Resource__get_Key_fn(Resource* __this, uString** __retval)
{
    *__retval = __this->Key();
}

// private generated void set_Key(string value) :1300
void Resource__set_Key_fn(Resource* __this, uString* value)
{
    __this->Key(value);
}

// public override sealed Uno.IDisposable Subscribe(Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1306
void Resource__Subscribe_fn(Resource* __this, uObject* context, uObject* listener, uObject** __retval)
{
    return *__retval = ::g::Fuse::Reactive::IContext::SubscribeResource(uInterface(uPtr(context), ::TYPES[28/*Fuse.Reactive.IContext*/]), (uObject*)__this, __this->Key(), listener), void();
}

// public generated string get_Key() [instance] :1300
uString* Resource::Key()
{
    return _Key;
}

// private generated void set_Key(string value) [instance] :1300
...
{
    ::STRINGS[102] = uString::Const("{Resource ");
    ::STRINGS[41] = uString::Const("} not found in data context");
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[30] = ::g::Uno::IDisposable_typeof();
    ::TYPES[68] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
        ::TYPES[30/*Uno.IDisposable*/], offsetof(ResourceSubscription_type, interface0));
    type->SetFields(0,
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::ResourceSubscription, _diag), 0,
...
void ResourceSubscription::OnChanged()
{
    ...
    if (uPtr(uPtr(_origin)->Parent())->TryGetResource(_key, uDelegate::New(::TYPES[68/*Uno.Predicate<object>*/], (void*)ResourceSubscription__Accept_fn, this), &resource))
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[5/*Fuse.Reactive.IListener*/]), _source, resource);
    else
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[102/*"{Resource "*/], _key), ::STRINGS[41/*"} not found...*/]), _origin);
}
...
static void RootableScriptModule_build(uType* type)
{
    ...
    ::TYPES[69] = ::g::Uno::Collections::IList_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetInterfaces(
...
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    while (nt != NULL)
    {
        ...
        {
            argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[103/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(i)));
            ::g::Uno::Collections::List__Add_fn(uPtr(args), uPtr(__this->_worker)->Unwrap((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nt->Objects()), ::TYPES[69/*Uno.Collections.IList<object>*/]), uCRef<int>(i), &ret3), ret3)));
        }
...
// public sealed class Snapshot :1325
// {
...
// public generated Fuse.Reactive.Expression get_Source() :1327
void Snapshot__get_Source_fn(Snapshot* __this, ::g::Fuse::Reactive::Expression** __retval)
{
    *__retval = __this->Source();
}

// private generated void set_Source(Fuse.Reactive.Expression value) :1327
void Snapshot__set_Source_fn(Snapshot* __this, ::g::Fuse::Reactive::Expression* value)
{
    __this->Source(value);
}

// public override sealed Uno.IDisposable Subscribe(Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1335
...
// public generated Fuse.Reactive.Expression get_Source() [instance] :1327
::g::Fuse::Reactive::Expression* Snapshot::Source()
{
    return _Source;
}

// private generated void set_Source(Fuse.Reactive.Expression value) [instance] :1327
...
// private sealed class TernaryOperator.Subscription :1544
// {
static void TernaryOperator__Subscription_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::InnerListener_type, interface0),
    ...
    type->SetFields(2,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::TernaryOperator__Subscription, _firstSub), 0,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::TernaryOperator__Subscription, _secondSub), 0,
        uObject_typeof(), offsetof(::g::Fuse::Reactive::TernaryOperator__Subscription, _third), 0,
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::TernaryOperator__Subscription, _thirdSub), 0,
...
// protected Subscription(Fuse.Reactive.TernaryOperator to, Fuse.Reactive.IListener listener) :1556
...
// public static Fuse.Reactive.TernaryOperator.Subscription Create(Fuse.Reactive.TernaryOperator to, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1562
...
// public override sealed void Dispose() :1602
void TernaryOperator__Subscription__Dispose_fn(TernaryOperator__Subscription* __this)
{
    ...
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_firstSub), ::TYPES[30/*Uno.IDisposable*/]));
        __this->_firstSub = NULL;
    }

    if (__this->_secondSub != NULL)
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_secondSub), ::TYPES[30/*Uno.IDisposable*/]));
        __this->_secondSub = NULL;
    }

    if (__this->_thirdSub != NULL)
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_thirdSub), ::TYPES[30/*Uno.IDisposable*/]));
...
// protected void Init(Fuse.Reactive.IContext context) :1571
void TernaryOperator__Subscription__Init_fn(TernaryOperator__Subscription* __this, uObject* context)
{
    __this->Init(context);
}

// protected Subscription New(Fuse.Reactive.TernaryOperator to, Fuse.Reactive.IListener listener) :1556
...
// protected override sealed void OnNewData(Fuse.Reactive.IExpression source, object value) :1578
...
// protected void OnNewOperands(object first, object second, object third) :1588
...
// protected Subscription(Fuse.Reactive.TernaryOperator to, Fuse.Reactive.IListener listener) [instance] :1556
...
// protected void Init(Fuse.Reactive.IContext context) [instance] :1571
...
// protected void OnNewOperands(object first, object second, object third) [instance] :1588
...
// public static Fuse.Reactive.TernaryOperator.Subscription Create(Fuse.Reactive.TernaryOperator to, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) [static] :1562
...
// protected Subscription New(Fuse.Reactive.TernaryOperator to, Fuse.Reactive.IListener listener) [static] :1556
...
static void BinaryOperator__Subscription_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::BinaryOperator__Subscription, _leftSub), 0,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::BinaryOperator__Subscription, _rightSub), 0);
}
...
void BinaryOperator__Subscription__Dispose_fn(BinaryOperator__Subscription* __this)
{
    ...
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_leftSub), ::TYPES[30/*Uno.IDisposable*/]));
        __this->_leftSub = NULL;
    }

    if (__this->_rightSub != NULL)
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_rightSub), ::TYPES[30/*Uno.IDisposable*/]));
...
// protected class UnaryOperator.Subscription :1661
// {
static void UnaryOperator__Subscription_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
        ::TYPES[30/*Uno.IDisposable*/], offsetof(UnaryOperator__Subscription_type, interface0),
    ...
    type->SetFields(2,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::UnaryOperator__Subscription, _operandSub), 0,
...
// protected Subscription(Fuse.Reactive.UnaryOperator uo, Fuse.Reactive.IListener listener) :1667
...
// public static Fuse.Reactive.UnaryOperator.Subscription Create(Fuse.Reactive.UnaryOperator uo, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1673
...
// public override void Dispose() :1687
void UnaryOperator__Subscription__Dispose_fn(UnaryOperator__Subscription* __this)
{
    ::g::Fuse::Reactive::InnerListener__Dispose_fn(__this);

    if (__this->_operandSub != NULL)
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_operandSub), ::TYPES[30/*Uno.IDisposable*/]));

    __this->_operandSub = NULL;
}

// protected void Init(Fuse.Reactive.IContext context) :1682
void UnaryOperator__Subscription__Init_fn(UnaryOperator__Subscription* __this, uObject* context)
{
    __this->Init(context);
}

// protected Subscription New(Fuse.Reactive.UnaryOperator uo, Fuse.Reactive.IListener listener) :1667
...
// protected override sealed void OnNewData(Fuse.Reactive.IExpression source, object value) :1694
...
// protected virtual void OnNewOperand(object value) :1699
...
// protected void PushNewData(object value) :1713
...
// protected Subscription(Fuse.Reactive.UnaryOperator uo, Fuse.Reactive.IListener listener) [instance] :1667
...
// protected void Init(Fuse.Reactive.IContext context) [instance] :1682
void UnaryOperator__Subscription::Init(uObject* context)
{
    _operandSub = uPtr(uPtr(_uo)->Operand())->Subscribe(context, (uObject*)this);
}

// protected void PushNewData(object value) [instance] :1713
...
// public static Fuse.Reactive.UnaryOperator.Subscription Create(Fuse.Reactive.UnaryOperator uo, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) [static] :1673
...
// protected Subscription New(Fuse.Reactive.UnaryOperator uo, Fuse.Reactive.IListener listener) [static] :1667
...
// private sealed class Snapshot.Subscription :1340
// {
static void Snapshot__Subscription_build(uType* type)
{
    ...
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
        ::TYPES[30/*Uno.IDisposable*/], offsetof(Snapshot__Subscription_type, interface0),
    ...
    type->SetFields(0,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::Snapshot__Subscription, _sub), 0);
}
...
// public Subscription(Fuse.Reactive.Snapshot snap, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1346
...
// public void Dispose() :1353
void Snapshot__Subscription__Dispose_fn(Snapshot__Subscription* __this)
{
    __this->Dispose();
}

// private void Fuse.Reactive.IListener.OnNewData(Fuse.Reactive.IExpression source, object value) :1363
...
// public Subscription New(Fuse.Reactive.Snapshot snap, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1346
...
// public Subscription(Fuse.Reactive.Snapshot snap, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) [instance] :1346
...
// public void Dispose() [instance] :1353
...
// public Subscription New(Fuse.Reactive.Snapshot snap, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) [static] :1346
...
{
    ::STRINGS[77] = uString::Const("clear");
    ::STRINGS[104] = uString::Const("replaceAllWithOrigin");
    ::STRINGS[105] = uString::Const("Unexpected null object");
    ::STRINGS[6] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.1.1/$.uno");
    ::STRINGS[106] = uString::Const("SetExclusive");
    ::STRINGS[107] = uString::Const("setValueWithOrigin");
    ::STRINGS[108] = uString::Const("Failed to set Observable value");
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[29] = ::g::Fuse::IArray_typeof();
    ::TYPES[11] = ::g::Fuse::Scripting::ScriptException_typeof();
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[77/*"clear"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[20/*int*/], _origin)));
}
...
{
    uArray* arr = uArray::New(::TYPES[3/*object[]*/], ::g::Fuse::IArray::Length(uInterface(uPtr(newValues), ::TYPES[29/*Fuse.IArray*/])));

    for (int i = 0; i < arr->Length(); i++)
        uPtr(arr)->Strong<uObject*>(i) = uPtr(uPtr(_om)->_worker)->Unwrap(::g::Fuse::IArray::Item(uInterface(uPtr(newValues), ::TYPES[29/*Fuse.IArray*/]), i));

    ::g::Fuse::Scripting::Array* sa = uPtr(uPtr(uPtr(_om)->_worker)->Context())->NewArray(arr);
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[104/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, sa, uBox<int>(::TYPES[20/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[105/*"Unexpected ...*/], this, ::STRINGS[6/*"/Users/Omka...*/], 649, ::STRINGS[106/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[107/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_worker)->Unwrap(newValue), uBox<int>(::TYPES[20/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[108/*"Failed to s...*/], ex, this, ::STRINGS[6/*"/Users/Omka...*/], 664, ::STRINGS[106/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
// private sealed class QuaternaryOperator.Subscription :1196
// {
static void QuaternaryOperator__Subscription_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::QuaternaryOperator__Subscription, _firstSub), 0,
        uObject_typeof(), offsetof(::g::Fuse::Reactive::QuaternaryOperator__Subscription, _fourth), 0,
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::QuaternaryOperator__Subscription, _fourthSub), 0,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::QuaternaryOperator__Subscription, _secondSub), 0,
        uObject_typeof(), offsetof(::g::Fuse::Reactive::QuaternaryOperator__Subscription, _third), 0,
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::QuaternaryOperator__Subscription, _thirdSub), 0);
}
...
// protected Subscription(Fuse.Reactive.QuaternaryOperator qo, Fuse.Reactive.IListener listener) :1209
...
// public static Fuse.Reactive.QuaternaryOperator.Subscription Create(Fuse.Reactive.QuaternaryOperator qo, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1215
...
// public override sealed void Dispose() :1257
void QuaternaryOperator__Subscription__Dispose_fn(QuaternaryOperator__Subscription* __this)
{
    ...
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_fourthSub), ::TYPES[30/*Uno.IDisposable*/]));
...
// protected void Init(Fuse.Reactive.IContext context) :1224
void QuaternaryOperator__Subscription__Init_fn(QuaternaryOperator__Subscription* __this, uObject* context)
{
    __this->Init(context);
}

// protected Subscription New(Fuse.Reactive.QuaternaryOperator qo, Fuse.Reactive.IListener listener) :1209
...
// protected override sealed void OnNewData(Fuse.Reactive.IExpression source, object value) :1232
...
// protected void OnNewOperands(object first, object second, object third, object fourth) :1243
...
// protected Subscription(Fuse.Reactive.QuaternaryOperator qo, Fuse.Reactive.IListener listener) [instance] :1209
...
// protected void Init(Fuse.Reactive.IContext context) [instance] :1224
...
// protected void OnNewOperands(object first, object second, object third, object fourth) [instance] :1243
...
// public static Fuse.Reactive.QuaternaryOperator.Subscription Create(Fuse.Reactive.QuaternaryOperator qo, Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) [static] :1215
...
// protected Subscription New(Fuse.Reactive.QuaternaryOperator qo, Fuse.Reactive.IListener listener) [static] :1209
...
// private sealed class Property.Subscription :1110
// {
...
// public Subscription(Fuse.Reactive.Property prop, Uno.UX.PropertyObject obj, Uno.UX.PropertyAccessor accessor, Fuse.Reactive.IListener listener) :1117
...
// public void Dispose() :1136
void Property__Subscription__Dispose_fn(Property__Subscription* __this)
{
    __this->Dispose();
}

// public Subscription New(Fuse.Reactive.Property prop, Uno.UX.PropertyObject obj, Uno.UX.PropertyAccessor accessor, Fuse.Reactive.IListener listener) :1117
...
// public Subscription(Fuse.Reactive.Property prop, Uno.UX.PropertyObject obj, Uno.UX.PropertyAccessor accessor, Fuse.Reactive.IListener listener) [instance] :1117
...
// public void Dispose() [instance] :1136
...
// private void PushValue() [instance] :1149
...
// public void SetExclusive(object value) [instance] :1129
...
// public Subscription New(Fuse.Reactive.Property prop, Uno.UX.PropertyObject obj, Uno.UX.PropertyAccessor accessor, Fuse.Reactive.IListener listener) [static] :1117
...
// public sealed class Subtract :908
// {
...
// protected override sealed object Compute(object left, object right) :912
...
// public override sealed string get_Symbol() :917
void Subtract__get_Symbol_fn(Subtract* __this, uString** __retval)
{
    return *__retval = ::STRINGS[109/*"-"*/], void();
}
// }
...
// public abstract class TernaryOperator :1520
// {
...
// public generated Fuse.Reactive.Expression get_First() :1522
void TernaryOperator__get_First_fn(TernaryOperator* __this, ::g::Fuse::Reactive::Expression** __retval)
{
    *__retval = __this->First();
}

// private generated void set_First(Fuse.Reactive.Expression value) :1522
...
// public generated Fuse.Reactive.Expression get_Third() :1524
void TernaryOperator__get_Third_fn(TernaryOperator* __this, ::g::Fuse::Reactive::Expression** __retval)
{
    *__retval = __this->Third();
}

// private generated void set_Third(Fuse.Reactive.Expression value) :1524
void TernaryOperator__set_Third_fn(TernaryOperator* __this, ::g::Fuse::Reactive::Expression* value)
{
    __this->Third(value);
}

// public generated Fuse.Reactive.Expression get_First() [instance] :1522
::g::Fuse::Reactive::Expression* TernaryOperator::First()
{
    return _First;
}

// private generated void set_First(Fuse.Reactive.Expression value) [instance] :1522
...
// public generated Fuse.Reactive.Expression get_Second() [instance] :1523
::g::Fuse::Reactive::Expression* TernaryOperator::Second()
{
    return _Second;
}

// private generated void set_Second(Fuse.Reactive.Expression value) [instance] :1523
void TernaryOperator::Second(::g::Fuse::Reactive::Expression* value)
{
    _Second = value;
}

// public generated Fuse.Reactive.Expression get_Third() [instance] :1524
::g::Fuse::Reactive::Expression* TernaryOperator::Third()
{
    return _Third;
}

// private generated void set_Third(Fuse.Reactive.Expression value) [instance] :1524
...
void This__GetValue_fn(This* __this, uObject* context, uObject** __retval)
{
    if (::g::Fuse::Reactive::IContext::NameTable(uInterface(uPtr(context), ::TYPES[28/*Fuse.Reactive.IContext*/])) != NULL)
    {
        uObject* obj = uPtr(::g::Fuse::Reactive::IContext::NameTable(uInterface(uPtr(context), ::TYPES[28/*Fuse.Reactive.IContext*/])))->This();
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(uObject_typeof(), uArray::New(::TYPES[71/*Fuse.Scripting.ScriptMember[]*/], 0));
}
...
static void ThreadWorker_build(uType* type)
{
    ...
    ::TYPES[72] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Reactive::Observable__Operation_typeof(), NULL);
    ::TYPES[73] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Scripting::ScriptClass_typeof(), ::g::Fuse::Scripting::Function_typeof(), NULL);
    ::TYPES[74] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[75] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL);
    ::TYPES[76] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[26] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[25] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[16] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[77] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[78] = ::g::Fuse::IProperties_typeof();
    ::TYPES[79] = ::g::Fuse::Reactive::ClassInstance_typeof();
    ::TYPES[58] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[80] = ::g::Fuse::Scripting::ScriptMethodInline_typeof();
    ::TYPES[81] = ::g::Fuse::Scripting::ScriptMethod_typeof();
    ::TYPES[82] = ::g::Fuse::Scripting::ScriptProperty_typeof();
    ::TYPES[34] = ::g::Uno::Exception_typeof();
    ::TYPES[14] = ::g::Uno::Action_typeof();
    ::TYPES[24] = ::g::Uno::String_typeof();
    ::TYPES[83] = ::g::Fuse::IRaw_typeof();
    ::TYPES[84] = ::g::Uno::Float2_typeof();
    ::TYPES[85] = ::g::Uno::Float3_typeof();
    ::TYPES[86] = ::g::Uno::Float4_typeof();
    ::TYPES[87] = ::g::Uno::Int2_typeof();
    ::TYPES[88] = ::g::Uno::Int3_typeof();
    ::TYPES[89] = ::g::Uno::Int4_typeof();
    ::TYPES[21] = ::g::Uno::Float_typeof();
    ::TYPES[20] = ::g::Uno::Int_typeof();
    ::TYPES[90] = ::g::Uno::UInt_typeof();
    ::TYPES[91] = ::g::Fuse::Scripting::IScriptObject_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ...
        ::TYPES[75/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _exceptionQueue), 0,
        ::g::Uno::Threading::ManualResetEvent_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _idle), 0,
        ::TYPES[72/*Uno.Collections.List<Fuse.Reactive.Observable.Operation>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _messages), 0,
        uObject_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _messagesMutex), 0,
        ::TYPES[74/*Uno.Threading.ConcurrentQueue<Uno.Action>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _queue), 0,
        ::g::Uno::Threading::ManualResetEvent_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _ready), 0,
        ::TYPES[20/*int*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _reflectionDepth), 0,
        ::TYPES[73/*Uno.Collections.Dictionary<Fuse.Scripting.ScriptClass, Fuse.Scripting.Function>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _registeredClasses), 0,
        ::TYPES[25/*Fuse.Scripting.Function*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _setSuperclass), 0,
...
{
    _messages = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[72/*Uno.Collections.List<Fuse.Reactive.Observable.Operation>*/]));
    _messagesMutex = ::g::Uno::Object::New();
    _registeredClasses = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[73/*Uno.Collections.Dictionary<Fuse.Scripting.ScriptClass, Fuse.Scripting.Function>*/]));
    ...
    _queue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[74/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
    _exceptionQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[75/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/]));
    _thread = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[76/*Uno.Threading.ThreadStart*/], (void*)ThreadWorker__Run_fn, this));
    uPtr(_thread)->Start();
    uPtr(_ready)->WaitOne();
    uPtr(_ready)->Dispose();
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[112/*"Skipped Exc...*/], next, this, ::STRINGS[6/*"/Users/Omka...*/], 1864, ::STRINGS[113/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[114/*"JavaScript ...*/], this, ::STRINGS[6/*"/Users/Omka...*/], 1434, ::STRINGS[115/*"CreateMirror"*/]);
        return NULL;
    }
...
{
    ::g::Fuse::Platform::Lifecycle::remove_Terminating(uDelegate::New(::TYPES[77/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
    uPtr(_terminate)->Set();
    uPtr(_thread)->Join();
...
{
    uObject* n = uAs<uObject*>(obj, ::TYPES[78/*Fuse.IProperties*/]);

    if (n != NULL)
    {
        ::g::Fuse::Reactive::ClassInstance* ni = uAs< ::g::Fuse::Reactive::ClassInstance*>(uPtr(::g::Fuse::IProperties::Properties(uInterface(uPtr(n), ::TYPES[78/*Fuse.IProperties*/])))->Get(_classInstanceProperty), ::TYPES[79/*Fuse.Reactive.ClassInstance*/]);

        if (ni == NULL)
        {
            ni = ::g::Fuse::Reactive::ClassInstance::New1(this, obj, rootTable);
            uPtr(::g::Fuse::IProperties::Properties(uInterface(uPtr(n), ::TYPES[78/*Fuse.IProperties*/])))->Set(_classInstanceProperty, ni);
        }
...
{
    ::g::Fuse::Scripting::External* e = uAs< ::g::Fuse::Scripting::External*>(obj, ::TYPES[58/*Fuse.Scripting.External*/]);
    ...
    if (sobj != NULL)
    {
        ...
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[118/*"external_ob...*/]), ::TYPES[58/*Fuse.Scripting.External*/]);
...
{
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[119/*" (ScriptCla...*/]), ::STRINGS[120/*"(function(e...*/]), ::TYPES[25/*Fuse.Scripting.Function*/]);
    ...
    if (sc->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::STRINGS[121/*"(set-superc...*/], ::STRINGS[122/*"(function(c...*/]), ::TYPES[25/*Fuse.Scripting.Function*/]);
    ...
    {
        ::g::Fuse::Scripting::ScriptMethodInline* inlineMethod = uAs< ::g::Fuse::Scripting::ScriptMethodInline*>(uPtr(uPtr(sc)->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[80/*Fuse.Scripting.ScriptMethodInline*/]);

        if (inlineMethod != NULL)
        {
            ::g::Fuse::Scripting::Function* m = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[34/*"."*/]), uPtr(inlineMethod)->Name), ::STRINGS[68/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[123/*"(function(c...*/], uPtr(inlineMethod)->Name), ::STRINGS[124/*" = "*/]), uPtr(inlineMethod)->Code), ::STRINGS[125/*"; })"*/])), ::TYPES[25/*Fuse.Scripting.Function*/]);
            uPtr(m)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, cl, (::g::Fuse::Scripting::Function*)uPtr(Context())->Observable()));
            continue;
        }

        ::g::Fuse::Scripting::ScriptMethod* method = uAs< ::g::Fuse::Scripting::ScriptMethod*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[81/*Fuse.Scripting.ScriptMethod*/]);
        ...
        ::g::Fuse::Scripting::ScriptProperty* property = uAs< ::g::Fuse::Scripting::ScriptProperty*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[82/*Fuse.Scripting.ScriptProperty*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[126/*"ThreadWorke...*/], e, this, ::STRINGS[6/*"/Users/Omka...*/], 1760, ::STRINGS[127/*"Run"*/]);
...
void ThreadWorker::RunInner()
{
    ...
    ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[14/*Uno.Action*/], (void*)ThreadWorker__ProcessUIMessages_fn, this), 0);
    ...
    while (true)
    {
        ...
        if (!_subscribedForClosing)
        {
            ...
            {
                ::g::Fuse::Platform::Lifecycle::add_Terminating(uDelegate::New(::TYPES[77/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
...
{
    return uPtr(Context())->NewArray(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, uBox(::TYPES[22/*double*/], (double)v.X), uBox(::TYPES[22/*double*/], (double)v.Y)));
}

// private Fuse.Scripting.Array ToArray(float3 v) [instance] :1961
::g::Fuse::Scripting::Array* ThreadWorker::ToArray1(::g::Uno::Float3 v)
{
    return uPtr(Context())->NewArray(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 3, uBox(::TYPES[22/*double*/], (double)v.X), uBox(::TYPES[22/*double*/], (double)v.Y), uBox(::TYPES[22/*double*/], (double)v.Z)));
}

// private Fuse.Scripting.Array ToArray(float4 v) [instance] :1966
::g::Fuse::Scripting::Array* ThreadWorker::ToArray2(::g::Uno::Float4 v)
{
    return uPtr(Context())->NewArray(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 4, uBox(::TYPES[22/*double*/], (double)v.X), uBox(::TYPES[22/*double*/], (double)v.Y), uBox(::TYPES[22/*double*/], (double)v.Z), uBox(::TYPES[22/*double*/], (double)v.W)));
}
...
uObject* ThreadWorker::Unwrap(uObject* dc)
{
    if (dc == NULL)
        ...
        return dc;
    else if (uIs(dc, ::TYPES[83/*Fuse.IRaw*/]))
        return ::g::Fuse::IRaw::Raw(uInterface(uPtr((uObject*)dc), ::TYPES[83/*Fuse.IRaw*/]));
    else if (uIs(dc, ::TYPES[25/*Fuse.Scripting.Function*/]))
        return dc;
    else if (uIs(dc, ::TYPES[84/*float2*/]))
        return ToArray(uUnbox< ::g::Uno::Float2>(::TYPES[84/*float2*/], dc));
    else if (uIs(dc, ::TYPES[85/*float3*/]))
        return ToArray1(uUnbox< ::g::Uno::Float3>(::TYPES[85/*float3*/], dc));
    else if (uIs(dc, ::TYPES[86/*float4*/]))
        return ToArray2(uUnbox< ::g::Uno::Float4>(::TYPES[86/*float4*/], dc));
    else if (uIs(dc, ::TYPES[87/*int2*/]))
        return ToArray3(uUnbox< ::g::Uno::Int2>(::TYPES[87/*int2*/], dc));
    else if (uIs(dc, ::TYPES[88/*int3*/]))
        return ToArray4(uUnbox< ::g::Uno::Int3>(::TYPES[88/*int3*/], dc));
    else if (uIs(dc, ::TYPES[89/*int4*/]))
        return ToArray5(uUnbox< ::g::Uno::Int4>(::TYPES[89/*int4*/], dc));
...
{
    uObject* so = uAs<uObject*>(obj, ::TYPES[91/*Fuse.Scripting.IScriptObject*/]);

    if ((so != NULL) && (::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[91/*Fuse.Scripting.IScriptObject*/])) != NULL))
        return ::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[91/*Fuse.Scripting.IScriptObject*/]));
    ...
    if (so != NULL)
        ::g::Fuse::Scripting::IScriptObject::SetScriptObject(uInterface(uPtr(so), ::TYPES[91/*Fuse.Scripting.IScriptObject*/]), res, Context());
...
uObject* ThreadWorker::Wrap(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[58/*Fuse.Scripting.External*/]))
        return uPtr(uCast< ::g::Fuse::Scripting::External*>(obj, ::TYPES[58/*Fuse.Scripting.External*/]))->Object;
    ...
    if (uIs(obj, ::TYPES[90/*uint*/]))
        return uBox(::TYPES[22/*double*/], (double)uUnbox<uint32_t>(::TYPES[90/*uint*/], obj));
...
// public abstract class UnaryOperator :1638
// {
...
// public generated Fuse.Reactive.Expression get_Operand() :1640
void UnaryOperator__get_Operand_fn(UnaryOperator* __this, ::g::Fuse::Reactive::Expression** __retval)
{
    *__retval = __this->Operand();
}

// private generated void set_Operand(Fuse.Reactive.Expression value) :1640
void UnaryOperator__set_Operand_fn(UnaryOperator* __this, ::g::Fuse::Reactive::Expression* value)
{
    __this->Operand(value);
}

// public override Uno.IDisposable Subscribe(Fuse.Reactive.IContext context, Fuse.Reactive.IListener listener) :1646
...
// protected UnaryOperator(Fuse.Reactive.Expression operand) [instance] :1641
...
// protected object Compute(object operand) [instance] :1651
...
// protected void OnNewOperand(Fuse.Reactive.IListener listener, object operand) [instance] :1656
...
// public generated Fuse.Reactive.Expression get_Operand() [instance] :1640
::g::Fuse::Reactive::Expression* UnaryOperator::Operand()
{
    return _Operand;
}

// private generated void set_Operand(Fuse.Reactive.Expression value) [instance] :1640
...
{
    ::TYPES[92] = ValueForwarder__IValueListener_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Reactive::ValueObserver_type, interface0),
        ::g::Fuse::Reactive::IObserver_typeof(), offsetof(::g::Fuse::Reactive::ValueObserver_type, interface1));
    type->SetFields(2,
        ::TYPES[92/*Fuse.Reactive.ValueForwarder.IValueListener*/], offsetof(::g::Fuse::Reactive::ValueForwarder, _listener), 0);
}
...
{
    ValueForwarder__IValueListener::NewValue(uInterface(uPtr(__this->_listener), ::TYPES[92/*Fuse.Reactive.ValueForwarder.IValueListener*/]), newValue);
}
...
static void ValueObserver_build(uType* type)
{
    ...
    ::TYPES[30] = ::g::Uno::IDisposable_typeof();
    type->SetInterfaces(
        ::TYPES[30/*Uno.IDisposable*/], offsetof(ValueObserver_type, interface0),
    ...
    type->SetFields(0,
        ...
        ::TYPES[30/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::ValueObserver, _obsSub), 0);
}
...
{
    __this->PushData(::g::Fuse::IArray::Item(uInterface(uPtr(__this->_obs), ::TYPES[29/*Fuse.IArray*/]), 0));
}
...
{
    if (::g::Fuse::IArray::Length(uInterface(uPtr(__this->_obs), ::TYPES[29/*Fuse.IArray*/])) > 0)
        __this->PushData(::g::Fuse::IArray::Item(uInterface(uPtr(__this->_obs), ::TYPES[29/*Fuse.IArray*/]), 0));
}
...
{
    if (_obsSub != NULL)
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_obsSub), ::TYPES[30/*Uno.IDisposable*/]));
...
// public sealed class Vector3 :1755
// {
...
// protected override sealed object Compute(object first, object second, object third) :1760
void Vector3__Compute_fn(Vector3* __this, uObject* first, uObject* second, uObject* third, uObject** __retval)
{
    return *__retval = uBox(::TYPES[85/*float3*/], ::g::Uno::Float3__New2(::g::Fuse::Marshal::ToFloat(first), ::g::Fuse::Marshal::ToFloat(second), ::g::Fuse::Marshal::ToFloat(third))), void();
}

// public override sealed string ToString() :1765
void Vector3__ToString_fn(Vector3* __this, uString** __retval)
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[12/*"("*/], __this->First()), ::STRINGS[103/*", "*/]), __this->Second()), ::STRINGS[103/*", "*/]), __this->Third()), ::STRINGS[10/*")"*/]), void();
}
// }
...
// protected override sealed object Compute(object first, object second, object third, object fourth) :1776
void Vector4__Compute_fn(Vector4* __this, uObject* first, uObject* second, uObject* third, uObject* fourth, uObject** __retval)
{
    return *__retval = uBox(::TYPES[86/*float4*/], ::g::Uno::Float4__New2(::g::Fuse::Marshal::ToFloat(first), ::g::Fuse::Marshal::ToFloat(second), ::g::Fuse::Marshal::ToFloat(third), ::g::Fuse::Marshal::ToFloat(fourth))), void();
}

// public override sealed string ToString() :1781
void Vector4__ToString_fn(Vector4* __this, uString** __retval)
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[12/*"("*/], __this->First()), ::STRINGS[103/*", "*/]), __this->Second()), ::STRINGS[103/*", "*/]), __this->Third()), ::STRINGS[103/*", "*/]), __this->Fourth()), ::STRINGS[10/*")"*/]), void();
}
// }
...
// private sealed class Instantiator.WindowItem :1170
// {
