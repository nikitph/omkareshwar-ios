...
static void ExploreItem__Template1_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("DETAILS");
...
void ExploreItem__Template1__New1_fn(ExploreItem__Template1* __this, uObject** __retval)
{
    ...
    __this->temp_Value_inst = ::g::exploring_FuseControlsTextControl_Value_Property::New1(temp, ExploreItem__Template1::__selector0());
