...
{
    MainView__Template::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 1, ::STRINGS[0/*"topItem"*/]);
    MainView__Template::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Value"*/]);
    MainView__Template::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"InDetailsMode"*/]);
    MainView__Template::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"ImageName"*/]);
    MainView__Template::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"Country"*/]);
    MainView__Template::__selector4_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"ForegroundC...*/]);
    MainView__Template::__selector5_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[6/*"CardAlignment"*/]);
    MainView__Template::__selector6_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"topItem"*/]);
}
...
static void MainView__Template_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Fuse::Elements::Alignment_typeof(), NULL), offsetof(::g::MainView__Template, __self_CardAlignment_inst1), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template, __self_Country_inst1), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(::g::MainView__Template, __self_ForegroundColor_inst1), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template, __self_ImageName_inst1), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Bool_typeof(), NULL), offsetof(::g::MainView__Template, __self_InDetailsMode_inst1), 0,
        ...
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MainView__Template::__selector5_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MainView__Template::__selector6_, uFieldFlagsStatic);
}
...
void MainView__Template__New1_fn(MainView__Template* __this, uObject** __retval)
{
    ...
    __this->temp_Value_inst = ::g::exploring_FuseSelectionSelectable_Value_Property::New1(temp, MainView__Template::__selector0());
    ...
    __this->__self_InDetailsMode_inst1 = ::g::exploring_ExploreItem_InDetailsMode_Property::New1(__self1, MainView__Template::__selector1());
    __this->__self_ImageName_inst1 = ::g::exploring_ExploreItem_ImageName_Property::New1(__self1, MainView__Template::__selector2());
    ::g::Fuse::Reactive::Data* temp2 = ::g::Fuse::Reactive::Data::New1(::STRINGS[8/*"name"*/]);
    __this->__self_Country_inst1 = ::g::exploring_ExploreItem_Country_Property::New1(__self1, MainView__Template::__selector3());
    ::g::Fuse::Reactive::Data* temp3 = ::g::Fuse::Reactive::Data::New1(::STRINGS[9/*"country"*/]);
    __this->__self_ForegroundColor_inst1 = ::g::exploring_ExploreItem_ForegroundColor_Property::New1(__self1, MainView__Template::__selector4());
    ::g::Fuse::Reactive::Data* temp4 = ::g::Fuse::Reactive::Data::New1(::STRINGS[10/*"color"*/]);
    __this->__self_CardAlignment_inst1 = ::g::exploring_ExploreItem_CardAlignment_Property::New1(__self1, MainView__Template::__selector5());
    ...
    __self1->Name(MainView__Template::__selector6());
    temp6->Mode(1);
