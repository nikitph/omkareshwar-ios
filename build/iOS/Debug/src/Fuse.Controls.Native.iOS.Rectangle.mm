...
// internal sealed extern class Rectangle :1551
// {
...
// public generated Rectangle() :1551
void Rectangle__ctor_5_fn(Rectangle* __this)
{
    __this->ctor_5();
}

// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) :1634
...
// private static ObjC.Object CreateUIBezierPath() :1607
void Rectangle__CreateUIBezierPath_fn(::g::ObjC::Object** __retval)
{
    *__retval = Rectangle::CreateUIBezierPath();
}

// private void Fuse.Controls.Native.IRectangleView.set_CornerRadius(float4 value) :1556
...
// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) [instance] :1634
...
// private void AddLineToPoint(ObjC.Object handle, float x, float y) [instance] :1627
...
// private void ClosePath(ObjC.Object handle) [instance] :1613
...
// private void MoveToPoint(ObjC.Object handle, float x, float y) [instance] :1620
...
// private static ObjC.Object CreateUIBezierPath() [static] :1607
...
// public generated Rectangle New() [static] :1551
