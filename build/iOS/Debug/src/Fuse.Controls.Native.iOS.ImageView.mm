...
static void ImageView_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/1.1.1/ios/$.uno");
...
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*"MultiDensit...*/], this, ::STRINGS[1/*"/Users/Omka...*/], 632, ::STRINGS[2/*"UpdateImage"*/]);
}
