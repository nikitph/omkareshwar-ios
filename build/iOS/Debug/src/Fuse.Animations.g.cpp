...
// /Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Animations/1.1.1/$.uno
// ---------------------------------------------------------------------------------------------
...
static void Attractor_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/Omkareshwar/Library/Application Support/Fusetools/Packages/Fuse.Animations/1.1.1/$.uno");
...
void Attractor::Motion(::g::Fuse::Motion::DestinationMotion* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"Motion shou...*/], this, ::STRINGS[1/*"/Users/Omka...*/], 201, ::STRINGS[2/*"set_Motion"*/], NULL);
}
...
void ContinuousTrackChangeState__SeekValue_fn(ContinuousTrackChangeState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 1, ::STRINGS[1/*"/Users/Omka...*/], 686);
        return;
    }
...
void CycleState__Seek_fn(CycleState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"Invalid seek"*/], 1, ::STRINGS[1/*"/Users/Omka...*/], 1010);
...
void DiscreteTrackChangeState__SeekObjectValue_fn(DiscreteTrackChangeState* __this, uObject* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 1, ::STRINGS[1/*"/Users/Omka...*/], 653);
        return;
    }
...
void MasterBase::Register(::g::Fuse::Animations::MixerHandle* handle)
{
    ...
    if (_inactive)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[7/*"Attempt to ...*/], this, ::STRINGS[1/*"/Users/Omka...*/], 1636, ::STRINGS[8/*"Register"*/]);
        return;
    }
...
void MixerHandle__Set_fn(MixerHandle* __this, void* value, float* strength)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[13/*"invalid Mix...*/], 1, ::STRINGS[1/*"/Users/Omka...*/], 1909);
        return;
    }
...
// public generated Resize New() :2688
...
// public float2 get_Vector() [instance] :2730
...
// public void set_Vector(float2 value) [instance] :2731
...
// public generated Resize New() [static] :2688
Resize* Resize::New2()
{
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Resize star...*/], r, ::STRINGS[1/*"/Users/Omka...*/], 2754, ::STRINGS[16/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Resize star...*/], r, ::STRINGS[1/*"/Users/Omka...*/], 2762, ::STRINGS[16/*".ctor"*/]);
        _valid = false;
        return;
    }
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"Invalid seek"*/], 1, ::STRINGS[1/*"/Users/Omka...*/], 2903);
        return *__retval = true, void();
    }
...
// public float3 get_Vector() [instance] :3571
...
// public void set_Vector(float3 value) [instance] :3572
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if ((__this->mixHandle == NULL) || (__this->transform == NULL))
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[6/*"Invalid seek"*/], 1, ::STRINGS[1/*"/Users/Omka...*/], 3645);
        return;
    }
