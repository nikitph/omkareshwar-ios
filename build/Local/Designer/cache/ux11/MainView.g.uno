...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp22 = new global::Fuse.Reactive.Data("inDetailsMode");
        ...
        var temp28 = new global::Fuse.Drawing.LinearGradient();
        ...
        var temp38 = new global::Fuse.Reactive.DataBinding(temp_Value_inst, temp21, __g_nametable, Fuse.Reactive.BindingMode.Default);
        var temp39 = new global::Fuse.Controls.Panel();
        citiesPageControl = new global::Fuse.Controls.PageControl();
        var temp40 = new global::Fuse.Animations.Change<bool>(sw_UserScroll_inst);
        var temp41 = new global::Fuse.Reactive.DataBinding(temp1_Value_inst, temp22, __g_nametable, Fuse.Reactive.BindingMode.Default);
        var temp42 = new global::Fuse.Controls.StackPanel();
        var temp43 = new global::Fuse.Reactive.DataBinding(temp2_Value_inst, temp23, __g_nametable, Fuse.Reactive.BindingMode.Write);
        var topItem = new Template(this, this);
        var temp44 = new global::Fuse.Reactive.DataBinding(temp3_Items_inst, temp24, __g_nametable, Fuse.Reactive.BindingMode.Default);
        temp25.LineNumber = 2;
        ...
        temp26.Children.Add(topBar);
        temp26.Children.Add(temp39);
        temp27.Style = Fuse.Platform.StatusBarStyle.Light;
        temp28.StartPoint = float2(0f, 0f);
        temp28.EndPoint = float2(0f, 1f);
        temp28.Stops.Add(temp29);
        temp28.Stops.Add(temp30);
        temp29.Offset = 0f;
        temp29.Color = float4(0.6156863f, 0.6352941f, 0.6901961f, 1f);
        temp30.Offset = 1f;
        temp30.Color = float4(0.145098f, 0.1647059f, 0.2156863f, 1f);
        global::Fuse.Controls.Grid.SetRow(temp31, 0);
        global::Fuse.Controls.Grid.SetRowSpan(temp31, 3);
        temp31.Children.Add(temp32);
        temp32.Rows = "3*,180,3*";
        temp32.Columns = "1*,1*";
        temp32.Children.Add(detailsImagePanel);
        temp32.Children.Add(detailsPlacesPanel);
        temp32.Children.Add(detailsInfoPanel);
        temp32.Children.Add(detailsFactsPanel);
        ...
        topBar.Children.Add(temp33);
        topBar.Children.Add(temp35);
        topBar.Children.Add(temp);
        temp33.Color = float4(0.3647059f, 0.3882353f, 0.4509804f, 1f);
        temp33.Children.Add(temp34);
        temp35.Height = new Uno.UX.Size(50f, Uno.UX.Unit.Unspecified);
        temp35.Children.Add(temp36);
        temp36.Value = "।। ॐक\u093Eर\u0947श\u094Dवर ।।";
        temp36.FontSize = 20f;
        temp36.TextColor = float4(0.9882353f, 0.7372549f, 0.3176471f, 1f);
        temp36.Alignment = Fuse.Elements.Alignment.Center;
        temp36.Margin = float4(25f, 0f, 25f, 0f);
        ...
        temp39.Children.Add(citiesPageControl);
